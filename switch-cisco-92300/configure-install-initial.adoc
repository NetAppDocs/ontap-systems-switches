...
summary: "Configure the Cisco Nexus 92300YC cluster switch to prepare it for cluster operation."
---
= Configure the Cisco Nexus 92300YC cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Configure the Cisco Nexus 92300YC cluster switch using initial setup commands to prepare it for cluster operation.
...
.What's next?
After you've configured your switches, you can 
link:install-nxos-overview.html[prepare to install the NX-OS software and RCF].