 ...
 ** Initial customization of the switch are complete, as detailed in:
+
link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-92300/configure-overview.html[Configuring a new Cisco Nexus 92300YC switch^]
+
...
. For ONTAP 9.4 and later, enable the cluster switch health monitor log collection feature for collecting switch-related log files, using gthe commamds:
+
