...
summary: "Replace a defective Cisco Nexus 92300YC cluster switch in a cluster network. This is a nondisruptive procedure."
---
= Replace a Cisco Nexus 92300YC cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective Cisco Nexus 92300YC cluster switch in a cluster network without disrupting cluster operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and migrating connections from the failed switch.
