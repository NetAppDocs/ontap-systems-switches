...
summary: "Install or upgrade the reference configuration file (RCF) on Cisco Nexus 92300YC cluster switches after initial setup or when a newer version is available."
---
= Install or upgrade the RCF on Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 92300YC cluster switches after initial setup, or upgrade your RCF version when a newer version is available.
...
. Copy the RCF to the bootflash of switch cs2 using one of the following transfer protocols: FTP, TFTP, SFTP, or SCP. For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade[Cisco Nexus 9000 Series Switches^].
+
...
+
For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade[Cisco Nexus 9000 Series Switches^].
+
