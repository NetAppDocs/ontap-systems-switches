...
summary: "Follow this workflow to install and configure Cisco Nexus 92300YC cluster switches in an ONTAP environment."
---
= Installation and setup workflow for Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure Cisco Nexus 92300YC cluster switches in an ONTAP environment. The 92300YC supports ONTAP clusters with more than two nodes. 
...
// AFFFASDOC-260 and AFFFASDOC-416, 2025-DEC-03 - Removal of old migration adoc files for CN1610 and 5996. I've added copies of .adoc files to the AFFFASDOC-416 ticket. 
