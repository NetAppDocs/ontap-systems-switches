...
* The initial preparation requirements, kit contents, and safety precautions in the link:http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexu9000/hw/installation/guide/b_n3000_hardware_install_guide.html[Cisco Nexus 9000 Series Hardware Installation Guide^].
