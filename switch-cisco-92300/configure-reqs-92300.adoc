...
summary: "Review the configuration requirements for Cisco Nexus 92300YC cluster switches before installation or upgrade."
---
= Review configuration requirements for Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the configuration requirements for Cisco Nexus 92300YC cluster switches before installation or upgrade. 
...
.What's next
After you've reviewed the configuration requirements, you can confirm your
