...
summary: "Follow this workflow to install NX-OS software and the RCF on Cisco Nexus 92300YC cluster switches."
---
= Software installation workflow for Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install NX-OS software and the reference configuration file (RCF) on Cisco Nexus 92300YC cluster switches.
