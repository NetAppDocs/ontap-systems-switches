...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png[Three]link:install-switch-netapp-cabinet-92300yc.html[Install the switch in a NetApp cabinet]
[role="quick-margin-para"]
