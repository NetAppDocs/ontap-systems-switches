...
summary: "Learn about Cisco Nexus 92300YC cluster switches and their role in ONTAP cluster networking."
---
= Learn about Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
The Cisco Nexus 92300YC is a cluster switch for ONTAP environments with more than two nodes. Review the capabilities and use cases for this switch before deploying it in your cluster.
...
a|
https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-92300/migrate-to-92300yc.html[_Migrate from an older Cisco Switch to a Cisco Nexus 92300YC Switch_^]
a|
