...
summary: "Prepare Cisco Nexus 92300YC cluster switches before installing NX-OS software and the reference configuration file (RCF)."
---
= Prepare to install NX-OS software and RCF on Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Prepare Cisco Nexus 92300YC cluster switches before installing NX-OS software and the reference configuration file (RCF). NX-OS and the RCF must be installed before the switch can operate in an ONTAP cluster.
...
After you've prepared to install the NX-OS software and RCF, you can 
