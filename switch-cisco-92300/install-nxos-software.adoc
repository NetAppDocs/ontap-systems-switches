...
summary: "Install the NX-OS software on Cisco Nexus 92300YC cluster switches to prepare them for cluster operation."
---
= Install NX-OS software on Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the NX-OS software on Cisco Nexus 92300YC cluster switches to prepare them for cluster operation. NX-OS must be installed before you can configure the switch or install the RCF.
...
.What's next?
After you've installed the NX-OS software, you can 
link:install-the-rcf-file.html[install the RCF].
