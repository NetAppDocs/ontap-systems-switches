...
summary: "Complete the cabling worksheet for Cisco Nexus 92300YC cluster switches to document port connections and supported platform configurations."
---
= Complete the Cisco Nexus 92300YC cabling worksheet
:icons: font
:imagesdir: ../media/

[.lead]
Complete the cabling worksheet for Cisco Nexus 92300YC cluster switches to document port connections and supported platform configurations. 
...
.What's next
After you've completed your cabling worksheets, you can link:install-switch-92300yc.html[install the switch].
