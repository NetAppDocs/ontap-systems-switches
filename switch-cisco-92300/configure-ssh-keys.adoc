...
summary: "SSH is a requirement when using the Cluster Switch Health Monitor CSHM and log collection features. To enable SSH on Cisco 92300YC cluster switches, you generate the SSH keys first and then enable SSH."
---
