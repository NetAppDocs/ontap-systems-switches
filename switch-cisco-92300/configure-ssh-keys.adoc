...
summary: "Verify that SSH and SSH keys are enabled on Cisco Nexus 92300YC cluster switches to support CSHM and log collection."
---
= Verify the SSH configuration for Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Verify that SSH and SSH keys are enabled on Cisco Nexus 92300YC cluster switches to support the Ethernet Switch Health Monitor (CSHM) and log collection features.
...
// Updates for GH issues #204 & 207, 2024-SEP-26
