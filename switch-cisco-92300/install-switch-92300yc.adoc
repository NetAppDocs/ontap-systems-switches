...
summary: "Install Cisco Nexus 92300YC cluster switches to prepare them for network operation."
---
= Install Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install and set up Cisco Nexus 92300YC cluster switches to prepare them for network operation.
...
a|
Refer to the _Installing a Cisco Nexus 92300YC cluster switch and pass-through panel in a NetApp cabinet_ guide for instructions to install the switch in a NetApp cabinet.
a|
