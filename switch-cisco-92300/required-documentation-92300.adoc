...
summary: "Review the documentation required to install and maintain Cisco Nexus 92300YC cluster switches."
---
= Review documentation requirements for Cisco Nexus 92300YC cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 92300YC cluster switches and configure them in an ONTAP cluster. 

== Switch documentation

To set up the Cisco Nexus 92300YC switches, you need the following documentation from link:https://www.cisco.com/site/us/en/products/networking/cloud-networking-switches/nexus-9200-series-switches/index.html[Cisco Nexus 9000 Series Switches Support^].
...
To install a Cisco Nexus 92300YC switch in a NetApp cabinet, refer to the following hardware documentation.
