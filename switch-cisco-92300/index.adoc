...
---
= Overview and requirements: Cisco Nexus 92300YC switches
:icons: font
:imagesdir: ../media/

[.lead]
For Cisco Nexus 92300YC switch installation and maintenance, be sure to review all requirements and recommended documentation. 
...
You need specific switch and controller documentation to set up your Cisco Nexus 92300YC switches and ONTAP cluster.
...
a|
link:install-switch-and-passthrough-panel.html[Install a Cisco Nexus 92300YC switch in a NetApp Cabinet]
a|
