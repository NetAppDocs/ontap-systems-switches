...
NOTE: If you are also upgrading your RCF at this time, follow the procedure to upgrade your RCF on switch cs2 before upgrading the EFOS on switch cs1. Refer to link:upgrade-rcf.html[upgrade the RCF version].
