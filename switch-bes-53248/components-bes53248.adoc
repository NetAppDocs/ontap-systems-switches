...
summary: "Identify the components and part numbers for the Broadcom BES-53248 cluster switch to support hardware installation and ongoing maintenance."
---
= Learn about components and part numbers for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Identify the components and part numbers for the Broadcom BES-53248 cluster switch to support hardware installation and ongoing maintenance.
...
.What's next
After you've confirmed your components and part numbers, you can review the  link:required-documentation-bes53248.html[required documentation].
