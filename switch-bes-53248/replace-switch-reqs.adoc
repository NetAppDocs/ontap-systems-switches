...
summary: "Review the conditions and requirements that must be met before replacing a Broadcom BES-53248 cluster switch."
---
= Review the requirements for replacing the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Review the conditions and requirements that must be met in the current environment and on the replacement Broadcom BES-53248 cluster switch before beginning the replacement procedure.
