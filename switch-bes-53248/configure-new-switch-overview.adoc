...
summary: "Follow this workflow to install and configure a new Broadcom BES-53248 cluster switch, from reviewing requirements through hardware and software setup."
---
= Installation and setup workflow for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure a new Broadcom BES-53248 cluster switch in an ONTAP environment. The BES-53248 is a bare metal switch that supports ONTAP clusters ranging from two to 24 nodes. 
...
[role="quick-margin-para"]
Configure Ethernet switch health monitoring.
