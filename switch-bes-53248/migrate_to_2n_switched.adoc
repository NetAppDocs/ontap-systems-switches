...
+
.Show example of disabled ports
[%collapsible]
====
...
+
.Show examples of neighboring devices
[%collapsible]
====
...
+
.Show examples of cluster port status
[%collapsible]
====
...
+
.Show example of cluster LIF status
[%collapsible]
====
...
+
.Show example of node-facing ports status
[%collapsible]
====
...
+
.Show example of cluster LIFs status
[%collapsible]
====
...
`cluster show`
+
.Show example of cluster node status
[%collapsible]
====
...
`cluster show`
+
.Show example of health and eligibility status
[%collapsible]
====
...
+
.Show example of connectivity status
[%collapsible]
====
