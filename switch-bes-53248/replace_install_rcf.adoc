...
CAUTION: See this link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/MetroCluster/BES-53248_communication_issue_after_firmware%2F%2FRCF_upgrade[KB^] for further information when installing an RCF for MetroCluster.  
