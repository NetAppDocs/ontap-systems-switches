...
summary: "Verify the health of the ONTAP cluster network after upgrading EFOS software or the RCF on the Broadcom BES-53248 cluster switch."
---
= Verify the ONTAP cluster network after upgrading EFOS software or the RCF on the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Verify the health of the ONTAP cluster network after upgrading the EFOS software or reference configuration file (RCF) on the Broadcom BES-53248 cluster switch.
