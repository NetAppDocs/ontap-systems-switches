...
summary: "The Broadcom BES-53248 cluster switch base model supports 16 10GbE or 25GbE ports and two 100GbE ports. Install additional port licenses to expand switch capacity."
---
= Install licenses for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
The Broadcom BES-53248 cluster switch base model is licensed for 16 10GbE or 25GbE ports and two 100GbE ports. Install additional port licenses to expand the switch to support more 10GbE or 25GbE cluster ports.
...
NOTE: To redeem a transaction key for a port license key file, refer to link:https://support.broadcom.com/web/csg/license-generation[License Portal for Broadcom Supported Ethernet Switches^]. Refer to the Knowledge Base article link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch[How to add Additional Port Licensing for the Broadcom BES-53248 Switch^] for further details.
...
After you've installed the licenses, you can link:configure-install-rcf.html[install the Reference Configuration File (RCF)] or link:upgrade-rcf.html[upgrade the RCF].

// Updates for AFFFASDOC-277, 2024-NOV-5
// AFFFASDOC-411, 2025-OCT-30
// AFFFASDOC-414, 2025-NOV-11
