...
NOTE: See the Knowledge Base article link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch[How to add Additional Port Licensing for the Broadcom BES-53248 Switch^] for further details.
