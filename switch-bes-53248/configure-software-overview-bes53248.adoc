...
summary: "Follow this workflow to install EFOS software and the RCF on a new Broadcom BES-53248 cluster switch."
---
= Software installation workflow for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install EFOS software and the reference configuration file (RCF) on a new Broadcom BES-53248 cluster switch.
