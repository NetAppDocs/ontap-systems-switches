...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four]link:configure-install-rcf.htm[Install the Reference Configuration File (RCF)]
[role="quick-margin-para"]
