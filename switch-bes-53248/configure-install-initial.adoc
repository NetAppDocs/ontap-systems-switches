...
summary: "Perform an initial configuration of the Broadcom BES-53248 cluster switch to prepare it for EFOS software installation and cluster deployment."
---
= Configure the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Perform the initial configuration of the Broadcom BES-53248 cluster switch to prepare it for EFOS software installation and cluster deployment.
...
* The cluster ports on each node are named `e0a` and `e0b`. Refer to the link:https://hwu.netapp.com/Home/Index[Hardware Universe^] for the actual cluster ports supported on your platform.
...
After you've configured your switches, you can link:configure-efos-software.html[install the EFOS software].
