...
* The cluster ports on each node are named `e0a` and `e0b`. Refer to  link:https://hwu.netapp.com/Home/Index[Hardware Universe^] for the actual cluster ports supported on your platform.
