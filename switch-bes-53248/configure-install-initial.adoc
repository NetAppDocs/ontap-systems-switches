...
[.lead]
Follow these steps to perform an initial set up of the BES-53248 cluster switch.

.What you'll need

* Hardware is installed, as described in link:/switch-bes-53248/install-hardware-bes53248.html[Install the hardware].
* You have reviewed the following:

** link:/switch-bes-53248/configure-reqs-bes53248.html[Configuration requirements]
** link:/switch-bes-53248/components-bes53248.html[Components and part numbers]
** link:/switch-bes-53248/required-documentation-53248.html[Documentation requirements]
