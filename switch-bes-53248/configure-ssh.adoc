...
summary: "Enable SSH on the Broadcom BES-53248 cluster switch to support the Ethernet switch health monitor (CSHM) and log collection features."
---
...
After you've enabled SSH, you can link:../switch-cshm/config-overview.html[configure switch health monitoring].
