...
After you edit a previously installed RCF file and then run the `script apply` command, you might get the following error message:
----
...
To either avoid or resolve the error, you can choose one of the following options:
