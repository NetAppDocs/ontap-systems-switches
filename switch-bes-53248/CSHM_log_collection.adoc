...
summary: "Configure log collection on the Broadcom BES-53248 cluster switch to enable CSHM to gather switch logs for debugging and AutoSupport reporting."
---
= Configure log collection for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Configure log collection on the Broadcom BES-53248 cluster switch to enable the Ethernet switch health monitor (CSHM) to gather switch logs for debugging and AutoSupport reporting. This procedure sets up both on-demand support log collection and hourly periodic data collection.
