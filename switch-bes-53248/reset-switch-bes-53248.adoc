...
summary: "Reset the Broadcom BES-53248 cluster switch to factory defaults by erasing the current switch configuration."
---
= Reset the Broadcom BES-53248 cluster switch to factory defaults

:icons: font
:imagesdir: ../media/

[.lead]
Reset the Broadcom BES-53248 cluster switch to factory defaults by erasing the current switch configuration and restoring the switch to its original settings.
