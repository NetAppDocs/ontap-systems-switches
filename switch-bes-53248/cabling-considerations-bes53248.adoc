...
summary: "Understand the cabling and configuration constraints for the Broadcom BES-53248 cluster switch before deployment, including cluster port assignments, port group speed constraints, and FEC settings."
---
= Review cabling and configuration requirements for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/
...
After you meet the cabling and configuration requirements, you install the link:configure-efos-software.html[install the EFOS software] on the switch.
