...
[.lead]
You can upgrade the Reference Configuration File (RCF) after configuring the BES-53248 cluster switch and after applying any new licenses.
...
[start=18]
. [[step18]]On cluster switch cs1, shut down the ports connected to the cluster ports of the nodes.
+
...
. Repeat steps 4 to 14 on switch cs1. 
