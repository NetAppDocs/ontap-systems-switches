...
//CAUTION: The file must be named `reference-config.scr` when you upload and apply the RCF file, otherwise the script apply step will fail.
...
[start=6]
. [[step6]]Enable auto-revert on the cluster LIFs:
+
[source,cli]
----
