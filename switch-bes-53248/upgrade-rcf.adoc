...
summary: 'You can upgrade the RCF after configuring the BES-53248 cluster switch and after applying any new licenses.'
---
= Upgrade the RCF version
:icons: font
:imagesdir: ../media/

[.lead]
You can upgrade the RCF after upgrading the BES-53248 cluster switch EFOS and after applying any new licenses.
