...
summary: "Review the EFOS and ONTAP version requirements and supported configurations for the Broadcom BES-53248 cluster switch before installation."
---
= Learn about configuration requirements for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Review the EFOS and ONTAP compatibility requirements and port configuration details for the Broadcom BES-53248 cluster switch before installation or upgrade.

== EFOS and ONTAP support

Refer to the link:https://hwu.netapp.com/Switch/Index[Hardware Universe^] and link:https://mysupport.netapp.com/site/info/broadcom-cluster-switch[Broadcom switches compatibility matrix^] for EFOS and ONTAP compatibility information with BES-53248 switches. EFOS and ONTAP support can vary by the specific machine type of the BES-53248 switch. For details of all BES-52348 switch machine types, refer to link:components-bes53248.html[Components and part numbers for BES-53248 cluster switches]. Refer to link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?]^ for more information about switch installation requirements.
...
* If you purchase additional licenses, refer to link:configure-licenses.html[Activate newly licenses ports] for details on how to activate them.
