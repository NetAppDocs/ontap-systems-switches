...
NOTE: See link:components-bes53248.hml[Components and part numbers for BES-53248 cluster switches] for details of the minimum EFOS version allowed for the newly available BES-53248 switch components. 
