...
summary: "Migrate existing NetApp CN1610 cluster switches to Broadcom BES-53248 cluster switches by following the migration requirements and procedure."
---
= Migrate from NetApp CN1610 cluster switches to Broadcom BES-53248 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate existing NetApp CN1610 cluster switches to Broadcom BES-53248 cluster switches. Review the migration requirements and then follow the migration procedure to replace the switches without disrupting cluster operation.
...
The link:https://hwu.netapp.com/Home/Index[Hardware Universe^] contains information about ONTAP compatibility, supported EFOS firmware, and cabling to BES-53248 cluster switches. Refer to link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?^] for more information about switch installation requirements.
