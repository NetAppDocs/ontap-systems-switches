...
* Some of the ports on BES-53248 switches are configured to run at 10 GbE or 40 GbE.
* The 10 GbE and 40 GbE connectivity from nodes to BES-53248 cluster switches have been planned, migrated, and documented.
...
. Is this required for *Jute*: Verify that the cluster displays information for both cluster switches:
+
