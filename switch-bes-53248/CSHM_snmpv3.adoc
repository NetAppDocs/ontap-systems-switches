...
summary: "Configure SNMPv3 on the Broadcom BES-53248 cluster switch to enable secure communication with the Ethernet switch health monitor (CSHM)."
---
= Configure SNMPv3 for the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Configure SNMPv3 on the Broadcom BES-53248 cluster switch to enable secure, authenticated communication with the Ethernet switch health monitor (CSHM). SNMPv3 provides encrypted polling of switch status for health monitoring in ONTAP.
