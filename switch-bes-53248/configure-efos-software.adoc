...
summary: "Install the Ethernet Fabric OS (EFOS) on the Broadcom BES-53248 cluster switch to prepare it for cluster operation."
---
= Install EFOS software on the Broadcom BES-53248 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Install the Ethernet Fabric OS (EFOS) on the Broadcom BES-53248 cluster switch to prepare it for cluster operation. EFOS must be installed before you configure the switch or install the reference configuration file (RCF).
...
Follow these four steps to reconfigure the switch:
...
. Complete the installation.
The switch reboots with no configuration applied and resets to factory defaults. Follow these five steps to reconfigure the switch:
...
.What's next
After you've installed the EFOS software, you can:

* link:configure-licenses.html[Install your licenses].
* link:efos-install-rcf-license-file.html[Install the RCF and license file for EFOS 3.12.0.1 and later], if applicable to your setup.
