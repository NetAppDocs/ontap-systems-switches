...
----
====
See the following table for guidance on protocols you can use when downloading the image file:
|===

h| *Protocol* h| *Guidance* 
...
a| If your software package supports secure management
a| *Secure Copy Protocol (SCP)*
a| If your software package supports secure management
a| *HTTP*
a| CLI-based file transfers are supported on selected platforms where a native wget utility is available
a| *HTTPS*
a| CLI-based file transfers are supported on selected platforms where a native WGET utility is available
