...
. Only optical connections are supported on SN2100 switches with X1151A NIC, X1146A NIC, or onboard 100GbE ports on AFF A800.
. When a QSA adapter is used to connect to the onboard Intel cluster ports on a platform, not all links come up. Example platforms are: (10G) FAS2750, AFF300, and FAS8200, and (25G) AFFA800. To resolve this issue, do the following:
