---
permalink: switch-nvidia-msn2100/migrate_cisco_msn2100_test_page.html
sidebar: sidebar
...
---
= Migrate from a Cisco cluster switch to a NVIDIA MSN2100 cluster switch - TEST PAGE
:icons: font
:imagesdir: ../media/
...
----------- ------ ------------------------- ----------------  ----------------
node1      /cdp
            e3a    c1                        0/1               N3K-C3232C
            e3b    c2                        0/1               N3K-C3232C
node2      /cdp
            e3a    c1                        0/2               N3K-C3232C
            e3b    c2                        0/2               N3K-C3232C
...
Device-ID             Local Intrfce Hldtme Capability  Platform         Port ID
node1                 Eth1/1        124    H           A400400           e3b
...
----------- ------ ------------------------- ----------------  ----------------
node1      /cdp
            e3a    sw1                       0/swp1            MSN2100-CB2RC
            e3b    sw2                       0/swp1            MSN2100-CB2RC
node2      /cdp
            e3a    sw1                       0/swp2            MSN2100-CB2RC
            e3b    sw2                       0/swp2            MSN2100-CB2RC

4 entries were displayed.
----

. Verify that both nodes each have one connection to each switch: `show cdp neighbors`
*This output needs updating*
+
...
Device-ID          Local Intrfce  Hldtme Capability  Platform      Port ID
node1              Eth1/1         124    H           AFF400        e3a
node2              Eth1/2         124    H           AFF400        e3a
...
Device-ID          Local Intrfce  Hldtme Capability  Platform      Port ID
node1              Eth1/1         124    H           FAS2750       e3b
node2              Eth1/2         124    H           FAS2750       e3b
