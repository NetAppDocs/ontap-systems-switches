...
summary: "Use Ethernet switch health monitor alerts to identify and resolve network switch issues in your ONTAP cluster."
---
= Learn about Ethernet switch health monitoring alerts in ONTAP
:icons: font
:imagesdir: ../media/
...
After you configure CSHM, the health monitors continuously check your network switches for potential issues. When a health monitor detects a fault or risk, it generates an alert that includes diagnostic information to help you respond quickly. You can view active alerts to identify current issues and view available alert definitions to understand which conditions are being monitored.
