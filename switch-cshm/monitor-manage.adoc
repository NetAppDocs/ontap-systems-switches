...
summary: "Manually add, configure, or remove Ethernet switches from CSHM monitoring, or pause monitoring during maintenance."
---
= Manage Ethernet switch monitoring in ONTAP
:icons: font
:imagesdir: ../media/
