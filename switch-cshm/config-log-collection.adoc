...
CAUTION: If any error statuses are reported by the log collection feature (visible in the output of `system switch ethernet log show`), see link:monitor-troubleshoot.html[Troubleshoot log collection] for further details.
