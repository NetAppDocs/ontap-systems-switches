...
* For tech support log collection with NVIDIA switches, the _<user>_ for log collection must be permitted to passwordless run the cl-support command. To allow this usage, run the command:
...
// Update from Abraham (see Teams), 2024-SEP-17
