...
* For NVIDIA switches, the user for log collection must be permitted to run the log collection commands without displaying a password prompt. To allow this usage, run the command:
