...
+
For NVIDIA switches, make sure that the user has the necessary permissions as outlined in the Before you begin section. 
+
[source,cli]
----
...
*Note: Enter y if you want to use a different user to the default user*
