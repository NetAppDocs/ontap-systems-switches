...
+
*NOTE:* If answering `y` to the user specification prompt, make sure that the user has the necessary permissions as outlined in the Before you begin section. 
+
[source,cli]
----
