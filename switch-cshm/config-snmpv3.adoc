...
.About this task
The following commands are used to configure an SNMPv3 username on *Broadcom* and *Cisco* switches:
...
The following commands are used to configure an SNMPv3 username on *NVIDIA* switches:
// start of tabbed content 
...
.NVIDIA - CLI 5.4 and earlier
--
Configure an SNMPv3 username on NVIDIA SN2100 switches running CLI 5.4 and earlier:
...
.NVIDIA - CLI 5.5 and later
-- 
Configure an SNMPv3 username on NVIDIA SN2100 switches running CLI 5.5 and later:

* For *no authentication*:
+
[source,cli]
----
nv set service snmp-server username _SNMPv3_USER_ auth-none
----
* For *MD5/SHA authentication*:
+
[source,cli]
----
nv set service snmp-server username _SNMPv3_USER_ [auth-md5|auth-sha] _AUTH-PASSWORD_
----
* For *MD5/SHA authentication with AES/DES encryption*:
+
[source,cli]
----
nv set service snmp-server username _SNMPv3_USER_ [auth-md5|auth-sha] _AUTH-PASSWORD_ [encrypt-aes|encrypt-des] _PRIV-PASSWORD_
----
