...
summary: "Troubleshoot Ethernet switch health monitor (CSHM) log collection errors and failures."
---
= Troubleshoot log collection for the Ethernet switch health monitor
:icons: font
:imagesdir: ../media/
