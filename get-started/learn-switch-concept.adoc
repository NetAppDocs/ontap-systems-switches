...
---
= Learn about your ONTAP system switches
...
For a list of switches that are no longer available for purchase, but are still supported, refer to link:../overview-eod.html[End-of-availability switches].
