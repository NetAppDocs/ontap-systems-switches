...
[%collapsible]
====
* link:..switch-cisco-9332d-gx2b/install-configure-switches-in-afx-workflow-9332d.html[Install Cisco Nexus 9332D-GX2B switches^]

* link:..switch-cisco-9364d-gx2a/install-configure-switches-in-afx-workflow-9364d.html[Install Cisco Nexus 9364D-GX2A switches^]
====
...
[%collapsible]
====
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/afx-cable-overview.html[Cable the Cisco Nexus 9332D-GX2B switch^]

* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/afx-cable-overview.html[Cable the Cisco Nexus 9364D-GX2A switch^]
====
