...
* link:../switch-cisco-9336c-fx2-shared/configure-software-overview-9336c-shared.html[Configure Cisco Nexus 9336C-FX2 switch]
|===
...
After you have installed and set up your AFF/FAS controllers and , you must complete configuring your storage in ONTAP. Access the following instructions according to your deployment configuration.
