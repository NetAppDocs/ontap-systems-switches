...
[%collapsible]
====
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-switches.html[Install Cisco Nexus 9332D-GX2B or 9364D-GX2A switches for an AFX 1K system^]

* link:https://review.docs.netapp.com/us-en/ontap-afx/install-afx-2k/install-switches.html[Install Cisco Nexus 9332D-GX2B or 9364D-GX2A switches for an AFX 2K system^]
...
[%collapsible]
====
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/afx-cable-overview.html[Install Cisco Nexus 9332D-GX2B or 9364D-GX2A switches for an AFX 1K system^]

* link:https://review.docs.netapp.com/us-en/ontap-afx/install-afx-2k/afx-cable-overview.html[Install Cisco Nexus 9332D-GX2B or 9364D-GX2A switches for an AFX 2K system^]
====
