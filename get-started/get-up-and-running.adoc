...
* link:https://docs.netapp.com/us-en/ontap-afx_main/install-setup/install-switches.html[Install Cisco Nexus 9332D-GX2B switch^]

* link:https://docs.netapp.com/us-en/ontap-afx_main/install-setup/install-switches.html[Install Cisco Nexus 9364D-GX2A switch^]
