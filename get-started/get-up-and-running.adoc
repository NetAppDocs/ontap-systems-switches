...
[%rotate, grid="none", frame="none", cols="9,9,9,9",]
|===
a|

.AFX systems switches

* link:../switch-cisco-9332d-gx2b/install-switch-9332d-cluster.html[Install Cisco Nexus 9332D-GX2B switch]

* link:../switch-cisco-9364d-gx2a/install-switch-9364d-cluster.html[Install Cisco Nexus 9364D-GX2A switch]
...
* link:../switch-cisco-9332d-gx2b/setup-worksheet-9332d-cluster.html[Cable Cisco Nexus 9332D-GX2B switch]

* link:../switch-cisco-9364d-gx2a/setup-worksheet-9364d-cluster.html[Cable Cisco Nexus 9364D-GX2A switch]
