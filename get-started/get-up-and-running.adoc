...
[%collapsible]
====
//* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-switches.html[Install Cisco Nexus switches for an AFX 1K system^]

//* link:https://review.docs.netapp.com/us-en/ontap-afx/install-afx-2k/install-switches.html[Install Cisco Nexus switches for an AFX 2K system^]

* link:../switch-cisco-9332d-gx2b/install-prepare-9332d.html[Prepare to install the Cisco Nexus 9332D-GX2B switch^]

* link:../switch-cisco-9364d-gx2a/install-prepare-9364d.html[Prepare to install the Cisco Nexus 9364D-GX2A switch^]

* link:../switch-cisco-9808/install-prepare-9808.html[Prepare to install the Cisco Nexus 9808 switch^]
====
...
[%collapsible]
====
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/afx-cable-overview.html[Install Cisco Nexus switches for an AFX 1K system^]

* link:https://review.docs.netapp.com/us-en/ontap-afx/install-afx-2k/afx-cable-overview.html[Install Cisco Nexus switches for an AFX 2K system^]
====
...
* link:../switch-nvidia-sn2100-storage/cabling-considerations-sn2100-storage.html[Cable the NVIDIA SN2100 switch^]
====
...
[%collapsible]
====
* link:../switch-cisco-9332d-gx2b/configure-switch-workflow-9332d.html[Configure the Cisco Nexus 9332D-GX2B switch^]

* link:../switch-cisco-9364d-gx2a/configure-switch-workflow-9364d.html[Configure the Cisco Nexus 9364D-GX2A switch^]

* link:../switch-cisco-9808/configure-switch-workflow-9808.html[Configure the Cisco Nexus 9808 switch^]
====
