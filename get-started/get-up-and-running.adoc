...
[%collapsible]
====
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-switches.html[Install Cisco Nexus 9332D-GX2B switch^]

* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-switches.html[Install Cisco Nexus 9364D-GX2A switch^]
====
...
[%collapsible]
====
* link:../switch-cisco-9332d-gx2b/install-nxos-software-9332d-cluster-test.html[Install software for Cisco Nexus 9332D-GX2B switch^]
