...
NOTE: Refer to the NVIDIA documentation for details on link:https://networking-docs.nvidia.com/sn2000hw/latest/sn2100-sn2010-side-by-side-mounting-rail-kit[installing your SN2100 switch and rail kit^].
