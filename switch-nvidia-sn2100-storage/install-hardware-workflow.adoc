...
summary: "Follow this workflow to install the hardware for NVIDIA SN2100 storage switches."
---
= Hardware installation workflow for NVIDIA SN2100 storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure the hardware for NVIDIA SN2100 storage switches.
