...
[.lead]
Migrate from Cisco cluster switches to NVIDIA SN2100 cluster switches without disrupting cluster operation. Review the configuration information, port connections, and cabling requirements before beginning the migration.
...
* Refer to the link:https://hwu.netapp.com/[Hardware Universe^] for full details of supported ports and their configurations.
