...
summary: "Replace a defective NVIDIA SN2100 storage switch. This is a nondisruptive procedure."
---
= Replace an NVIDIA SN2100 storage switch
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective NVIDIA SN2100 storage switch without disrupting storage network operation. This nondisruptive procedure involves preparing a replacement switch and restoring the storage network configuration.

.Before you begin

Before installing the Cumulus software and RCFs on an NVIDIA SN2100 storage switch, ensure that:

* Your system can support NVIDIA SN2100 storage switches.
* You have downloaded the applicable RCFs.

The link:http://hwu.netapp.com[Hardware Universe^] provides full details of supported ports and their configurations.
