...
summary: "Review the configuration requirements for NVIDIA SN2100 storage switches before installation or upgrade."
---
= Review configuration requirements for NVIDIA SN2100 storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the configuration requirements for NVIDIA SN2100 storage switches before installation or upgrade. 
...
For cabling guidelines, refer to link:cabling-considerations-sn2100-storage.html[Cabling and configuration considerations].
...
* Cumulus Linux (CL) OS version 4.4.3. For current compatibility information, refer to link:https://mysupport.netapp.com/site/info/nvidia-cluster-switch[NVIDIA Ethernet Switches^].

* You can install Cumulus Linux when the switch is running Cumulus Linux or ONIE.

.What's next
After you've reviewed the configuration requirements, you can confirm your link:components-sn2100-storage.html[components and part numbers].
