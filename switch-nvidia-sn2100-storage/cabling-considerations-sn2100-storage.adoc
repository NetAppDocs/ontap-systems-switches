...
.What's next?
After you've reviewed your cabling and configuration requirements, you link:install-cable-shelves-sn2100-storage.html[cable the NS224 shelves as switch-attached storage].
