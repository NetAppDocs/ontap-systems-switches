...
summary: "Review the cabling and configuration considerations for NVIDIA SN2100 storage switches before deployment."
---
= Review cabling and configuration considerations for NVIDIA SN2100 storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the cabling and configuration considerations for NVIDIA SN2100 storage switches before deployment. 
...
.What's next?
After you've reviewed your cabling and configuration requirements, you can link:install-cable-shelves-sn2100-storage.html[cable the NS224 shelves as switch-attached storage].
