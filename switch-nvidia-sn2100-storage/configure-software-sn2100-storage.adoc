...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png[Six]link:reset-switch-sn2100-storage.html[Reset the switch to factory defaults]
[role="quick-margin-para"]
