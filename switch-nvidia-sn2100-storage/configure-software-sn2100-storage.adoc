...
summary: "Follow this workflow to install Cumulus Linux and the RCF on NVIDIA SN2100 storage switches."
---
= Software installation workflow for NVIDIA SN2100 storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install Cumulus Linux and the reference configuration file (RCF) on NVIDIA SN2100 storage switches.
