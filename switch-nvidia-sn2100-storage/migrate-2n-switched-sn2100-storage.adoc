...
summary: "Migrate an existing two-node switchless cluster to a switched cluster environment using NVIDIA SN2100 switches."
---
...
[.lead]
Migrate an existing two-node switchless cluster to a switched cluster environment using NVIDIA SN2100 switches. This nondisruptive migration enables you to scale the cluster beyond two nodes.
