...
summary: "Configure SNMPv3 on NVIDIA SN2100 storage switches to enable secure switch log collection and health monitoring."
---
= Configure SNMPv3 for NVIDIA SN2100 storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Configure SNMPv3 on NVIDIA SN2100 storage switches to enable secure, authenticated switch log collection and Ethernet switch health monitor (CSHM).
