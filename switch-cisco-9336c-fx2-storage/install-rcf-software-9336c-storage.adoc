...
[%collapsible]
====
This example shows the RCF `NX9336C-FX2-RCF-v1.13-1-Storage.txt` being installed on switch s1:
...
+
----
s1# copy running-config startup-config [########################################] 100% Copy complete
----
...
. Repeat steps 1 through 8 on switch s2.
