...
summary: "Install the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches after initial setup to configure port assignments and network settings."
---
= Install the RCF on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches after initial setup. The RCF defines port assignments and network settings required for storage network operation.
