...
summary: "Follow this workflow to install and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches in an ONTAP environment."
---
= Installation and setup workflow for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches in an ONTAP environment. These switches are part of the Cisco Nexus 9000 platform and support storage network connectivity for ONTAP systems.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-7.png[Seven]link:../switch-cshm/config-overview.html[Configure CSHM]
[role="quick-margin-para"]
