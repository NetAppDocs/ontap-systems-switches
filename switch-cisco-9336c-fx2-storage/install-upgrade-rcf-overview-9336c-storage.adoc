...
After you've reviewed the install RCF or upgrade RCF procedure, you link:install-rcf-software-9336c-storage.html[install the RCF] or link:upgrade-rcf-software-9336c-storage.html[upgrade your RCF] as required.
