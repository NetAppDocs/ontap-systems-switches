---
permalink: switch-cisco-9336c-fx2/migrate-to-9336-storage.html
sidebar: sidebar
...
.Before you begin
The following conditions must exist before migrating an older Cisco Nexus cluster switch to a Cisco Nexus 9336C-FX2 cluster switch:
...
* You must have referred to the appropriate software and upgrade guides available on the Cisco web site for the Cisco switch upgrade and downgrade procedures on https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.htmlCisco[Nexus 9000 Series Switches^].
