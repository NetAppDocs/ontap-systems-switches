...
summary: "Follow this workflow to install NX-OS software and the RCF on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches."
---
= Software installation workflow for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install NX-OS software and the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four]link:install-upgrade-rcf-overview-9336c-storage.html[Install or upgrade the RCF]
[role="quick-margin-para"]
