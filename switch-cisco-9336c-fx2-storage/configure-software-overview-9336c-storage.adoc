...
---
= Overview of software configuration for Cisco Nexus 9336C-FX2 storage switches
:icons: font
:imagesdir: ../media/

[.lead]

To initially configure software for a Cisco Nexus 9336C-FX2 switch, follow these steps:
