...
[.lead]
For Cisco Nexus 9336C-FX2 and 9336C-FX2-T switch installation, make sure to review specific switch and controller documentation to set up your Cisco 9336-FX2 switches and ONTAP cluster.
