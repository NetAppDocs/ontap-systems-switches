...
summary: "Review the switch and controller documentation required to set up and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches."
---
= Review documentation requirements for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches and configure them in an ONTAP storage network.

== Switch documentation
To set up the Cisco Nexus 9336C-FX2 switches, you need the following documentation from link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html[Cisco Nexus 9000 Series Switches Support^].
