...
----------- ------ ------------------------ --------------- ---------
cluster1-01/cdp 
            e3a    s1                       Ethernet1/7     N9K-C9336C
            e3b    s2                       Ethernet1/7     N9K-C9336C
cluster1-02/cdp
            e3a    s1                       Ethernet1/8     N9K-C9336C
...
cluster1::*> *system switch ethernet show*
  ...
  -------------------- ------------------ ---------------- ---------------
  s1                   cluster-network    1.2.3.4          N9K-C9336C-FX2
...
s2                   cluster-network    2.3.4.5          N9K-C9336C-FX2
...
+
`s1# show run | section "interface mgmt0" >> bootflash:write_erase.cfg`
+
...
`s1# echo "hardware access-list tcam region ing-racl 1024" >> bootflash:write_erase.cfg`
+
`s1# echo "hardware access-list tcam region egr-racl 1024" >> bootflash:write_erase.cfg`
+
`s1# echo "hardware access-list tcam region ing-l2-qos 1280 >> bootflash:write_erase.cfg`
+ 
...
. Repeat steps 1 to 17 on switch s2.
