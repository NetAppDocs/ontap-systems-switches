...
summary: "Upgrade the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches when a newer version is available."
---
= Upgrade the RCF on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches when a newer version of the RCF is available. 
...
. Log in to the switch s2 using SSH or by using a serial console. 
. Shut down the ports connected to all the ports of the nodes.
+
...
. Verify that the switch ports connected to the node storage ports and storage shelf ports are *up*.
+
[source,cli]
----
