...
---
= Install and configure the 9336C-FX2 storage switch
:icons: font
:imagesdir: ../media/
...
Optionally, you can link:install-switch-and-passthrough-panel-9336c-storage.html[install switch in NetApp cabinet]. Otherwise, go to link:configure-switch-overview-9336c-storage.html[Prepare to install NX-OS and RCF].