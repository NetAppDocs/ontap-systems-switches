...
---
= Reset the 9336C-FX2 storage switch to factory defaults

:icons: font
:imagesdir: ../media/

[.lead]
To reset the 9336C-FX2 storage switch to factory defaults, you must erase the 9336C-FX2 switch settings.
