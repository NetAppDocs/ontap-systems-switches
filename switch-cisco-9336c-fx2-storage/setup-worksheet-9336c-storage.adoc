...
summary: "Complete the cabling worksheet for Cisco Nexus 9336C-FX2 or 9336C-FX2-T storage switches to document port connections and supported platform configurations."
---
...
[.lead]
Complete the cabling worksheet for Cisco Nexus 9336C-FX2 or 9336C-FX2-T storage switches to document port connections and supported platform configurations. 
...
You can use the blank cabling worksheet to document the platforms that are supported as nodes in a cluster. The _Supported Cluster Connections_ section of the link:https://hwu.netapp.com[Hardware Universe^] defines the cluster ports used by the platform.
...
.What's next
After you've completed your cabling worksheets, you can link:install-9336c-storage.html[install the switch].
