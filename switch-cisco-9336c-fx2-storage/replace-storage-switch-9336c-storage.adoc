...
summary: "Replace a defective Cisco Nexus 9336C-FX2 or 9336C-FX2-T storage switch in a storage network. This is a nondisruptive procedure."
---
...
[.lead]
Replace a defective Cisco Nexus 9336C-FX2 or 9336C-FX2-T storage switch in a storage network without disrupting storage network operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and restoring the storage network configuration.
