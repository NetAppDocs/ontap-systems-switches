...
summary: "Install Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches and a pass-through panel in a NetApp cabinet using the standard brackets included with the switch."
---
= Install Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches in a NetApp cabinet
:icons: font
:imagesdir: ../media/

[.lead]
Install Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches and a pass-through panel in a NetApp cabinet using the standard brackets included with the switch.
...
After you've installed the switches in the NetApp cabinet, you can link:setup-switch-9336c-storage.html[configure the Cisco Nexus 9336C-FX2 and 9336C-FX2-T switches].
