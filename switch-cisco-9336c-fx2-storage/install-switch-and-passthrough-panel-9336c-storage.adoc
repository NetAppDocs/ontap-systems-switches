---
permalink: switch-cisco-9336c-fx2/install-switch-and-passthrough-panel-9336c-storage.html
sidebar: sidebar
...
.What's next?
link:setup-switch-9336c-storage.html[Configure the Cisco Nexus 9336C-FX2 switch]. 
