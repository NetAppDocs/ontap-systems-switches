...
summary: "Prepare Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches before installing NX-OS software and the reference configuration file (RCF)."
---
= Prepare to install NX-OS software and RCF on Cisco Nexus 9336C-FX2 storage switches

:icons: font
:imagesdir: ../media/

[.lead]
Prepare Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches before installing NX-OS software and the reference configuration file (RCF). NX-OS and the RCF must be installed before the switch can operate in an ONTAP storage network.
