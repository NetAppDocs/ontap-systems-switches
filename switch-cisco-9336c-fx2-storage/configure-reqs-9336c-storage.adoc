...
summary: "Review the ONTAP and NX-OS version requirements and supported configurations for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches before installation."
---
= Review configuration requirements for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the ONTAP and NX-OS version requirements and supported configurations for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches before installation or upgrade.
