...
summary: "Identify the components and part numbers for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches to support hardware installation and ongoing maintenance."
---
= Review components and part numbers for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Identify the components and part numbers for Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches to support hardware installation and ongoing maintenance.
...
.What's next
After you've confirmed your components and part numbers, you can review the link:required-documentation-9336c-storage.html[required documentation].
