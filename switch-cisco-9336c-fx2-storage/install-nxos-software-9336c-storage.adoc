...
summary: "Install or upgrade the NX-OS software on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches."
---
= Install or upgrade NX-OS software on Cisco Nexus 9336C-FX2 storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Install or upgrade the NX-OS software on Cisco Nexus 9336C-FX2 and 9336C-FX2-T storage switches. NX-OS must be installed before you can configure the switch or install the reference configuration file (RCF).
...
----
====
. If you are setting up your switch for the first time, skip to step 5. If you are upgrading your switch, proceed to the next step.
...
. After the switch reboots, log in again and verify that the new version of EPLD loaded successfully.
+
...
. If you are setting up your switch for the first time, skip to step 14. If you are upgrading your switch, proceed to the next step.

. Verify the health status of each node storage port and storage shelf port.
...
. Repeat steps 5 to 13 to install the NX-OS software on switch s1.

.What's next?
After you've installed or upgraded the NX-OS software, you can link:install-rcf-software-9336c-storage.html[install or upgrade the RCF].
