...
summary: "Set up and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches to prepare them for network operation."
---
= Install Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Set up and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches to prepare them for network operation.
...
a|
Refer to the _Installing a Cisco Nexus 9336C-FX2 cluster switch and pass-through panel in a NetApp cabinet_ guide for instructions to install the switch in a NetApp cabinet.
a|
