...
summary: "Review the switch and controller documentation required to set up and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches."
---
= Review documentation requirements for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches and configure them in an ONTAP cluster.

== Switch documentation
To set up the Cisco Nexus 9336C-FX2 and 9336C-FX2-T switches, you need the following documentation from link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html[Cisco Nexus 9000 Series Switches Support^].
...
To install a Cisco 9336-FX2 switch in a NetApp cabinet, refer to the following hardware documentation.

[options="header" cols="1,2"]
|===
| Name| Description
a|
link:https://library.netapp.com/ecm/ecm_download_file/ECMM1280394[42U System Cabinet, Deep Guide^]
a|
Describes the FRUs associated with the 42U system cabinet, and provides maintenance and FRU replacement instructions.
a|
link:install-switch-and-passthrough-panel-9336c-cluster.html[Install a Cisco 9336-FX2 switch in a NetApp Cabinet^]
a|
Describes how to install Cisco Nexus 9336C-FX2 and 9336C-FX2-T switches in a four-post NetApp cabinet.
|===

// Updated broken link for cabinet installation, 2023-FEB-22
// Updates for AFFFASDOC-388, 2025-MAY-19
