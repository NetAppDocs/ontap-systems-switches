...
summary: "Review the ONTAP and NX-OS version requirements and supported configurations for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches before installation."
---
= Review configuration requirements for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the ONTAP and NX-OS version requirements and supported configurations for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches before installation or upgrade.
...
* You have the appropriate number and type of cables and cable connectors for your switches. Refer to the link:https://hwu.netapp.com[Hardware Universe^].
