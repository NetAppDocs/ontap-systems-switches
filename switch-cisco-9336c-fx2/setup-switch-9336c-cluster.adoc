...
* Required cluster network and management network switch documentation. See link:required-documentation-9336c-cluster.html[Required documentation] for more information.
...
link:configure-switch-overview-9336c-cluster.html[Prepare to install NX-OS and RCF].