...
summary: "Configure the Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches to prepare them for cluster operation."
---
= Configure the Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Configure the Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches using initial setup commands to prepare them for cluster operation in an ONTAP environment.
...
After you've configured your switches, you can link:install-nxos-overview-9336c-cluster.html[prepare to install the NX-OS software and RCF].
