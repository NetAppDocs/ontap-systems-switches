...
summary: "Follow this workflow to install and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches in an ONTAP environment."
---
...
[.lead]
Follow this workflow to install and configure Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches in an ONTAP environment. These switches are part of the Cisco Nexus 9000 platform and support ONTAP clusters with more than two nodes. 
