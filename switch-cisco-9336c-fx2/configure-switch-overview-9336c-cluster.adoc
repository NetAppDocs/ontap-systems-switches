...
. link:install-switch-and-passthrough-panel-9336c-cluster.html[Install a Cisco Nexus 9336C-FX2 switch in a NetApp cabinet]. Install the Cisco Nexus 9336C-FX2 switch and pass-through panel in a NetApp cabinet with the standard brackets that are included with the switch.
. link:setup-switch-9336c-cluster.html[Configure the 9336C-FX2 cluster switch]. Set up and configure the Cisco Nexus 9336C-FX2 switch.
