...
For details of supported ports and their configurations, refer to link:https://hwu.netapp.com/[Hardware Universe^]. Refer to link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?^] for more information about switch installation requirements.
