...
---
= Migrate from a NetApp CN1610 cluster switch to a Cisco 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/
...
You must be aware of certain configuration information, port connections and cabling requirements when you are replacing NetApp CN1610 cluster switches with Cisco 9336C-FX2 and 9336C-FX2-T cluster switches. Also, verify the switch serial number to ensure that the correct switch is migrated.
