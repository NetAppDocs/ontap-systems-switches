...
FAS2820 e0a and e0b ports might require FEC configuration changes to link up with 9336C-FX2 switch ports.
For these switch ports e0a and e0b, the fec setting is set to `rs-cons16` while the controller side is set to `auto`.
