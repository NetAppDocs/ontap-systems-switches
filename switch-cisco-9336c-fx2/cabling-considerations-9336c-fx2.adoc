...
summary: "Review the cabling and configuration considerations for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches before deployment."
---
= Review cabling and configuration requirements for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the cabling and configuration considerations for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches before deployment. 
...
Refer to the Knowledge Base article link:https://kb.netapp.com/on-prem/Switches/Cisco-KBs/Ports_do_not_link_up_on_Cisco_Nexus_9336C-FX2_due_to_TCAM_resources[Ports do not link up on Cisco Nexus 9336C-FX2 due to TCAM resources^] for details on how to resolve this issue. 
