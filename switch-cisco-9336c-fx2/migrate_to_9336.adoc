...
. Confirm that the ISL is cabled and healthy between the switches cs1-new and cs2-new: `show port-channel summary`
+
[subs=+quotes]
----
...
----------- ------ ------------------------- ----------------  ----------------
node1      /cdp
            e0a    cs1                        0/1               N5K-C5596UP
            e0b    cs2                        0/1               N5K-C5596UP
node2      /cdp
            e0a    cs1                        0/2               N5K-C5596UP
            e0b    cs2                        0/2               N5K-C5596UP
----
...
node1      /cdp
            ...
            e0b    cs2-new                   0/1               N9K-C9336C

node2      /cdp
            e0a    c1                        0/2               N5K-C5596UP
            e0b    cs2-new                   0/2               N9K-C9336C
----
...
----------- ----------------- ---------- ------------------ ------------- ------- ----
Cluster
            node1_clus1       up/up      169.254.3.4/23     node1         e0b     false
            node1_clus2       up/up      169.254.3.5/23     node1         e0b     true
            node2_clus1       up/up      169.254.3.8/23     node2         e0b     false
            node2_clus2       up/up      169.254.3.9/23     node2         e0b     true
----
...
----------- ------ ------------------------- ----------------  ----------------
node1      /cdp
            e0a    cs1-new                   0/1               N9K-C9336C
            e0b    cs2-new                   0/1               N9K-C9336C

node2      /cdp
            e0a    cs1-new                   0/2               N9K-C9336C
            e0b    cs2-new                   0/2               N9K-C9336C
----
...
. For ONTAP 9.8 and later, enable the Ethernet switch health monitor log collection feature for collecting switch-related log files, using the following two commands: `system switch ethernet log setup-password` and `system switch ethernet log enable-collection`
+
