...
summary: "Replace a defective Cisco Nexus 9336C-FX2 storage switch by reviewing the port connections and cabling requirements before beginning."
---
...
[.lead]
Review the configuration information, port connections, and cabling requirements before replacing a Cisco Nexus 9336C-FX2 storage switch.
