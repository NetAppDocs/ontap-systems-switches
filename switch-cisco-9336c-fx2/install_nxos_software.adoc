...
Be sure to complete the procedure in link:install-nxos-overview.html[Prepare to install NX-OS and RCF], and then follow the steps below.
...
link:install-nxos-rcf.html[Install RCF config file].