...
NOTE: In order to enable more than 12 ports, you must purchase a Cisco SMART license, part number: SW-N9K-FX2-24P-UPG and use your Cisco SMART account to associate the new license with the respective switch serial number.
