...
NOTE: Once you have purchased your Smart license, install the appropriate RCF file to enable and configure all 36 available ports for use.



// Updates for MicroFleece AFFFASDOC-234, JUL-2024