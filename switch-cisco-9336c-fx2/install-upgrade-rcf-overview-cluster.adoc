...
a|
Cluster HA Breakout RCF 1._xx_ (2-Cluster-HA-Breakout)
a|
Supports two ONTAP clusters with at least eight nodes, including nodes that use shared Cluster+HA ports.
a|
Cluster HA Breakout RCF 1._xx_  (4-Cluster-HA-Breakout)
a|
...
a|
ClusterStorageRCF_1.xx_shared (Cluster-HA-Storage)
a|
