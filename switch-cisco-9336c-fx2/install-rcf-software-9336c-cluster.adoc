...
summary: "Install the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches after initial setup to configure port assignments, VLANs, and network settings."
---
= Install the RCF on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches after initial setup. The RCF defines port assignments, VLANs, and network settings required for cluster operation.
