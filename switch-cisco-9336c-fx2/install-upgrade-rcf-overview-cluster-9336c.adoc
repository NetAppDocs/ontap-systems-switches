...
summary: "SSH is a requirement when using the Cluster Switch Health Monitor and log collection features. To enable SSH on Cisco 9336c-fx2 cluster switches, you generate the SSH keys first and then enable SSH."
---
