...
summary: "Install or upgrade the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches after initial setup or when upgrading an existing RCF."
---
= Learn about installing or upgrading the RCF on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches after initial setup, or upgrade your RCF version when a newer version is available. 
...
The following table describes the RCFs available for different configurations. Choose the RCF applicable to your configuration. Refer to link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] for more information.

For specific port and VLAN usage details, refer to the banner and important notes section in your RCF.

[options="header" cols="1,2"]
|===
| RCF configuration | Description
a|
...
The following table lists the available RCFs for 9336C-FX2 and 9336C-FX2-T switches. Choose the applicable RCF version for your configuration. Refer to link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] for more information.
...
The examples in this procedure use four nodes. These nodes use two 10GbE cluster interconnect ports *e0a* and *e0b*. Refer to the link:https://hwu.netapp.com/SWITCH/INDEX[Hardware Universe^] to verify the correct cluster ports on your platforms.

NOTE: The command outputs might vary depending on different releases of ONTAP.

For details of the available RCF configurations, refer to the link:configure-software-overview-9336c-cluster.html[Software install workflow].
...
After you've reviewed the install RCF or upgrade RCF procedure, you can link:install-rcf-software-9336c-cluster.html[install the RCF] or link:upgrade-rcf-software-9336c-cluster.html[upgrade your RCF] as required.
