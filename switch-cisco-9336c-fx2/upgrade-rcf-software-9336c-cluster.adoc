...
CAUTION: If your 9336C-FX2 switch fails to boot after your RCF upgrade, refer to this Knowledge Base article link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared[Cisco 9336C-FX2 Switch Fails to Boot After RCF Install – Boot Variable Cleared^] for next steps.
