...
+
`echo "hardware access-list tcam region ing-racl 1024" >> bootflash:write_erase.cfg`
+
`echo "hardware access-list tcam region egr-racl 1024" >> bootflash:write_erase.cfg`
+
`echo "hardware access-list tcam region ing-l2-qos 1280" >> bootflash:write_erase.cfg`
