...
summary: "Replacing a defective Nexus 9336C-FX2 switch in a cluster network is a nondisruptive procedure."
---
...
[.lead]
Follow these steps to replace defective Nexus 9336C-FX2 and 9336C-FX2-T switches in a cluster network. This is a nondisruptive procedure (NDU).
