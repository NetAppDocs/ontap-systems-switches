...
summary: "Replace a defective Cisco Nexus 9336C-FX2 or 9336C-FX2-T cluster switch in a cluster network. This is a nondisruptive procedure."
---
= Replace Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective Cisco Nexus 9336C-FX2 or 9336C-FX2-T cluster switch in a cluster network without disrupting cluster operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and migrating connections from the failed switch.
