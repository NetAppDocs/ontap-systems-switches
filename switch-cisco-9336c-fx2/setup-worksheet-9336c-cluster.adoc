...
summary: "Complete the cabling worksheet for Cisco Nexus 9336C-FX2 or 9336C-FX2-T cluster switches to document port connections and supported platform configurations."
---
= Review the cabling worksheet for Cisco Nexus 9336C-FX2 or 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Complete the cabling worksheet for Cisco Nexus 9336C-FX2 or 9336C-FX2-T cluster switches to document port connections and supported platform configurations. 
...
.What's next
After you've completed your cabling worksheets, you can link:install-switch-9336c-cluster.html[install the switch].
