...
+
For specific port usage details, refer to the banner in your RCF.
+ 
...
a|
All ports are configured for 10/25/40/100GbE. Supports two HA interconnect networks, two clusters with at least eight nodes (2 x 8).
a|
NX9336C-4x4-MultiCluster-HA
a|
All ports are configured for 10/25/40/100GbE. Supports four HA interconnect networks. Four clusters with at least four nodes (4 x 4).
a|
Cluster-HA
a|
