...
summary: "Follow this workflow to install the hardware for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches."
---
= Hardware installation workflow for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure the hardware for Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches.
