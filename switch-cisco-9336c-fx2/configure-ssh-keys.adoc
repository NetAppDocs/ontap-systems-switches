...
summary: "Verify that SSH and SSH keys are enabled on Cisco Nexus 9336C-FX2 cluster switches to support CSHM and log collection."
---
= Verify the SSH configuration for Cisco Nexus 9336C-FX2 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Verify that SSH and SSH keys are enabled on Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches to support the Ethernet switch health monitor (CSHM) and log collection features.
