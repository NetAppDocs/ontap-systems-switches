...
.What's next?
After you've installed the switches in the NetApp cabinet, you link:setup-switch-9336c-cluster.html[configure the Cisco Nexus 9336C-FX2 and 9336C-FX2-T switches]. 
