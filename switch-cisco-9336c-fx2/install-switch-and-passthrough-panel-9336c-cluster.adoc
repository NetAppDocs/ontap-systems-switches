...
summary: "Install Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches and a pass-through panel in a NetApp cabinet using the standard brackets included with the switch."
---
= Install a Cisco Nexus 9336C-FX2 cluster switch and pass-through panel in a NetApp cabinet
:icons: font
:imagesdir: ../media/

[.lead]
Install Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches and a pass-through panel in a NetApp cabinet using the standard brackets included with the switch.
...
* For initial preparation requirements, kit contents, and safety precautions, refer to the link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html[Cisco Nexus 9000 Series Hardware Installation Guide^].
...
+
The two 9336C-FX2 and 9336C-FX2-T switches are always mounted in the top 2U of the cabinet RU41 and 42.
...
. Connect the management port on each 9336C-FX2 and 9336C-FX2-T switches to either of the management switches (if ordered) or connect them directly to your management network.
+
...
.What's next?
After you've installed the switches in the NetApp cabinet, you can link:setup-switch-9336c-cluster.html[configure the Cisco Nexus 9336C-FX2 and 9336C-FX2-T switches]. 
