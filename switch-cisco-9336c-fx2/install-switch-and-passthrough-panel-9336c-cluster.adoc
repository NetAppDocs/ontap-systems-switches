...
[.lead]
Depending on your configuration, you might need to install the Cisco Nexus 9336C-FX2 and 9336C-FX2-T switch and pass-through panel in a NetApp cabinet. Standard brackets are included with the switch.
