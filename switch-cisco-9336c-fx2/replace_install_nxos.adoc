---
permalink: switch-cisco-9336c-fx2/replace-install-nxos.html
sidebar: sidebar
...
[.lead]
Learn how to install the NX-OS software on the Nexus 9336C-FX2 cluster switch.
...
.Before you begin
Download the applicable NetApp Cisco NX-OS software for your switches from the NetApp Support Site at http://mysupport.netapp.com/[mysupport.netapp.com^].
