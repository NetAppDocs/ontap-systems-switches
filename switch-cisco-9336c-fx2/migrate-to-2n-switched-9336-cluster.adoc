...
summary: "Migrate an existing two-node switchless cluster to a switched cluster environment using Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches."
---
= Migrate to a two-node switched cluster using Cisco Nexus 9336C-FX2 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate an existing two-node switchless cluster to a switched cluster environment using Cisco Nexus 9336C-FX2 and 9336C-FX2-T cluster switches. This nondisruptive migration enables you to scale the cluster beyond two nodes.
...
** Refer to the link:https://hwu.netapp.com[Hardware Universe^] for all supported ONTAP versions.
...
+
Refer to the link:https://hwu.netapp.com[Hardware Universe^] for more information about cabling.
...
Refer to the link:https://hwu.netapp.com[Hardware Universe^] for information about the cluster ports for your platforms. Refer to link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?^] for more information about switch installation requirements.
...
. Disable auto-revert on all of the cluster LIFs: 
+
...
[%collapsible]
====
The following example shows that all of the LIFs are up on node1 and node2:
...
[start=10]
. [[step10]]Change the privilege level back to admin: 
+
`set -privilege admin`
