---
permalink: switch-cisco-9336c-fx2/setup-switch.html
sidebar: sidebar
...
* Completed link:setup-worksheet-9336c.html[cabling worksheets].
...
* Required cluster network and management network switch documentation. See xref:setup-required-documentation.adoc[Required documentation] for more information.
...
link:install-nxos-overview.html[Prepare to install NX-OS and RCF].