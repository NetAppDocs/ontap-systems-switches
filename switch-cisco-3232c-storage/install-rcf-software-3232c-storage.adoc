...
summary: "Install the reference configuration file (RCF) on Cisco Nexus 3232C storage switches after initial setup."
---
= Install the RCF on Cisco Nexus 3232C storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 3232C storage switches after initial setup. The RCF defines port assignments and network settings required for storage network operation.
