...
summary: "Verify that SSH and SSH keys are enabled on Cisco Nexus 3232C storage switches to support CSHM and log collection."
---
= Verify the SSH configuration for Cisco Nexus 3232C storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Verify that SSH and SSH keys are enabled on Cisco Nexus 3232C storage switches to support the Ethernet Switch Health Monitor (CSHM) and log collection features.
