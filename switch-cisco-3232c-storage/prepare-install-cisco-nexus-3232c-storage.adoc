...
summary: "Prepare Cisco Nexus 3232C storage switches before installing NX-OS software and the reference configuration file (RCF)."
---
= Prepare to install NX-OS software and RCF on Cisco Nexus 3232C storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Prepare Cisco Nexus 3232C storage switches before installing NX-OS software and the reference configuration file (RCF). NX-OS and the RCF must be installed before the switch can operate in an ONTAP storage network.
