...
summary: "You can use this procedure to install the NX-OS software on the Nexus 3232C storage switch."
---
...
. If you are setting up your switch for the first time, skip to step 17. If you are upgrading your switch, proceed to the next step.
...
. Repeat steps 6 to 13 and step 17 to install the NX-OS software on switch s1.
