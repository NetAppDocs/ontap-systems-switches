...
summary: "Install or upgrade the NX-OS software on Cisco Nexus 3232C storage switches."
---
= Install or upgrade NX-OS software on Cisco Nexus 3232C storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Install or upgrade the NX-OS software on Cisco Nexus 3232C storage switches to prepare them for storage network operation.
...
. If you are setting up your switch for the first time, skip to step 15. If you are upgrading your switch, proceed to the next step.
...
After you've installed the NX-OS software, you can link:install-rcf-software-3232c-storage.html[install or upgrade the Reference Configuration File (RCF)].
