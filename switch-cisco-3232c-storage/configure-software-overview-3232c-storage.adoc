...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png[Three]link:install-nx-os-software-3232c-storage.html[Install the NX-OS software]
[role="quick-margin-para"]
