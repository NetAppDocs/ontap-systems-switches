...
summary: "Replace a defective Cisco Nexus 3232C storage switch. This is a nondisruptive procedure."
---
...
[.lead]
Replace a defective Cisco Nexus 3232C storage switch without disrupting storage network operation. This nondisruptive procedure involves preparing a replacement switch and restoring the storage network configuration.
