...
summary: "You can install the Cisco Nexus 3232C storage switch and pass-through panel in a NetApp cabinet with the standard brackets that are included with the switch."
---
