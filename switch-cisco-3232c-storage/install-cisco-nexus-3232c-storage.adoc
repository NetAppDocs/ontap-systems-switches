...
summary: "Install a Cisco Nexus 3232C storage switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch."
---
...
[.lead]
Install a Cisco Nexus 3232C storage switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch.
...
. Install the rack-mount brackets on the Nexus 3232C storage switch chassis.
