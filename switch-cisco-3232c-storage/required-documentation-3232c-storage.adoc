...
summary: "Review the documentation required to install and maintain Cisco Nexus 3232C storage switches."
---
= Review documentation requirements for Cisco Nexus 3232C storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 3232C storage switches and configure them in an ONTAP storage network. 


== Switch documentation

To set up the Cisco Nexus 3232C switches, you need the following documentation from link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html[Cisco Nexus 3000 Series Switches Support^].
...
a|
link:install-cisco-nexus-3232c-storage.html[Install a Cisco Nexus 3232C switch in a NetApp Cabinet^]
a|
