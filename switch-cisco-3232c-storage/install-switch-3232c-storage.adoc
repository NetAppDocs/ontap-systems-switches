...
summary: "Install Cisco Nexus 3232C storage switches to prepare them for storage network operation."
---
= Install Cisco Nexus 3232C storage switches
:icons: font
:imagesdir: ../media/

[.lead]
Install Cisco Nexus 3232C storage switches to prepare them for storage network operation.
...
After you've installed the 3232C storage switch, you can then link:install-cisco-nexus-3232c-storage.html[install the switch in a NetApp cabinet].
