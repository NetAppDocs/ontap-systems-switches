...
* Completed cabling worksheets. Refer to link:cable-9336c-shared.html[Complete the Cisco Nexus 9336C-FX2 cabling worksheet]. For more information on cabling, refer to link:https://hwu.netapp.com[Hardware Universe^].
