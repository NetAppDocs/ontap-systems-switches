...
summary: "Follow this workflow to install the hardware for a Cisco Nexus 9336C-FX2 shared switch."
---
= Hardware installation workflow for Cisco Nexus 9336C-FX2 shared switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure the hardware for a Cisco Nexus 9336C-FX2 shared switch.
