...
[.lead]
For Cisco Nexus 9336C-FX2 switch installation, be sure to review specific switch and controller documentation to set up your Cisco 9336-FX2 switches and ONTAP cluster.
