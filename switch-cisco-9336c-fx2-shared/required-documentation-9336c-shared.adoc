...
summary: "Review the switch and controller documentation required to set up and configure Cisco Nexus 9336C-FX2 shared switches."
---
= Review documentation requirements for Cisco Nexus 9336C-FX2 shared switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 9336C-FX2 shared switches and configure them in an ONTAP environment.


To set up the Cisco Nexus 9336C-FX2 shared switches, refer to link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html[Cisco Nexus 9000 Series Switches Support^].
...
|link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/sw/mib/reference/MIBRef.html[Cisco Nexus 9000 MIBs Reference^]
