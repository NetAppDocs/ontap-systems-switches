...
//Refer to link:../switch-cisco-9336c-fx2/cabling-considerations-9336c-fx2.html[Review cabling and configuration considerations] for details of any further changes required.
