...
keywords:
summary: "Prepare a Cisco Nexus 9336C-FX2 shared switch before installing NX-OS software and the reference configuration file (RCF)."
---
= Prepare to install NX-OS software and RCF on a Cisco Nexus 9336C-FX2 shared switch
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Prepare a Cisco Nexus 9336C-FX2 shared switch before installing NX-OS software and the reference configuration file (RCF). NX-OS and the RCF must be installed before the switch can operate in an ONTAP environment.
...
// GH issue #340 internal repo, 2025-SEP-18
