...
summary: "Install a Cisco Nexus 9336C-FX2 shared switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch."
---
= Install a Cisco Nexus 9336C-FX2 shared switch in a NetApp cabinet
:icons: font
:imagesdir: ../media/

[.lead]
Install a Cisco Nexus 9336C-FX2 shared switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch.
