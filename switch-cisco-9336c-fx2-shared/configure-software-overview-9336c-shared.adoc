...
summary: "Follow this workflow to install NX-OS software and the RCF on a Cisco Nexus 9336C-FX2 shared switch."
---
= Software installation workflow for Cisco Nexus 9336C-FX2 shared switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install NX-OS software and the reference configuration file (RCF) on a Cisco Nexus 9336C-FX2 shared switch.
