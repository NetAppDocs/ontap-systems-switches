...
keywords:
summary: "Replace a defective Cisco Nexus 9336C-FX2 shared switch. This is a nondisruptive procedure."
---
...
[.lead]
Replace a defective Cisco Nexus 9336C-FX2 shared switch without disrupting cluster or storage network operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and restoring the shared switch configuration.
