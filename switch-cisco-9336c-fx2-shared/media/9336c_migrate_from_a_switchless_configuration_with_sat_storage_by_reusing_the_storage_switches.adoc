...
----
[start=7]
. [[step7]]Replace the storage RCF on shared switch A with the shared RCF file. See http://9336c_install_nx-os_software_and_reference_configuration_files_rcfs.html#install-the-rcf-on-a-cisco-nexus-9336c-fx2-shared-switch[Install the RCF on a Cisco Nexus 9336C-FX2 shared switch] for further details.
