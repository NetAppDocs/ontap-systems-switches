...
summary: "Install the NX-OS software on a Cisco Nexus 9336C-FX2 shared switch to prepare it for shared cluster and storage operation."
---
= Install NX-OS software on a Cisco Nexus 9336C-FX2 shared switch
:icons: font
:imagesdir: ../media/

[.lead]
Install the NX-OS software on a Cisco Nexus 9336C-FX2 shared switch to prepare it for shared cluster and storage operation.
