...
keywords:
summary: "Configure Cisco Nexus 9336C-FX2 shared switches to prepare them for combined cluster and storage operation."
---
...
[.lead]
Configure Cisco Nexus 9336C-FX2 shared switches to prepare them for combined cluster and storage network operation.
