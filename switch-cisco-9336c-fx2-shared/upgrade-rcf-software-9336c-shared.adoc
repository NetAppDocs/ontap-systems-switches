...
summary: "Upgrade the reference configuration file (RCF) on a Cisco Nexus 9336C-FX2 shared switch when a newer version is available."
---
= Upgrade the RCF on a Cisco Nexus 9336C-FX2 shared switch
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the reference configuration file (RCF) on a Cisco Nexus 9336C-FX2 shared switch when a newer version of the RCF is available. 
...
. Refer to link:cabling-considerations-9336c-shared.html[Review cabling and configuration considerations] for details of any further changes required. 
...
. Repeat steps 1 to 21 on switch cs2.
...
[subs=+quotes]
----
cluster1::*> *    cluster1::*> network interface check cluster-connectivity show*
...
After you've upgraded the RCF, you can link:../switch-cshm/config-overview.html[configure switch health monitoring].

// Updates for AFFFASDOC-288, 2025-JAN-29
// Updates for AFFFASDOC-377, 2025-AUG-20
// Updates for GH issue #281, 2025-AUG-18
