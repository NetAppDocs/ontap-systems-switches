...
keywords:
summary: "Migrate from a switchless cluster with direct-attached storage to Cisco Nexus 9336C-FX2 shared switches by adding two new shared switches."
---
= Migrate from a switchless cluster with direct-attached storage to Cisco Nexus 9336C-FX2 shared switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Migrate from a switchless cluster with direct-attached storage to Cisco Nexus 9336C-FX2 shared switches by adding two new shared switches.
...
Most systems require two dedicated cluster-network ports on each controller. Refer to link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] for more information.
...
* The cluster ports used in this procedure are _e3a_ and _e3b_, as per the AFF A400 controller. The link:https://hwu.netapp.com[Hardware Universe^] contains the latest information about the actual cluster ports for your platforms.
...
+
The link:https://hwu.netapp.com[Hardware Universe^] contains more information about cabling. Refer to link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?^] for more information about switch installation requirements.
