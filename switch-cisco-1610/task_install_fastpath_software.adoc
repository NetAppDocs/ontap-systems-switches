...
sidebar: sidebar
keywords: FASTPATH software,installing on NetApp switches,installing FASTPATH software on,NetApp switches
...
. Repeat step <<STEPS_3757CBF53D8544BA8A7673BE25BE9AF5,1>> through step <<STEP_18C3A9E39C114900A471A207DAECEDBE,18>> to upgrade the FASTPATH software on the other switch, cs1.
