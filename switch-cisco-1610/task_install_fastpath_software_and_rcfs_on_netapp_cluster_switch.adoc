...
* link:task_install_fastpath_software.html[Installing FASTPATH software] describes how to install the FASTPATH software.
* link:task_install_an_rcf_on_a_cn1610_switch.html[Installing an RCF on a CN1610 switch]describes how to install RCFs.
