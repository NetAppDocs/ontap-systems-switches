...
sidebar: sidebar
keywords: FASTPATH software,installing on CN1610 switch,installing RCFs,CN1610 switches
...
* link:task_install_fastpath_software.md#[Installing FASTPATH software] describes how to install the FASTPATH software.
* link:task_install_an_rcf_on_a_cn1610_switch.md#[Installing an RCF on a CN1610 switch]describes how to install RCFs.
