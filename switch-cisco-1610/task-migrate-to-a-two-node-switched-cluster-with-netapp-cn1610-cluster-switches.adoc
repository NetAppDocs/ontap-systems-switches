---
permalink: switch-cisco-1610/task-migrate-to-a-two-node-switched-cluster-with-netapp-cn1610-cluster-switches.html
sidebar: sidebar
...
* link:task_migrate_from_a_switchless_cluster_to_a_switched_netapp_cn1610_cluster_environment.html[Migrate from a switchless cluster to a switched NetApp CN1610 cluster environment]
* xref:task_migrate_from_a_switchless_cluster_fas22xx_systems_with_a_single_cluster_network_connection.adoc[Migrate from a switchless cluster (FAS22xx systems with a single cluster-network connection)]
