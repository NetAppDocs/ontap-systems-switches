...
.Cisco switches
--
Configure an SNMPv3 username SNMPv3_USER on Cisco Nexus switches:
...
.NVIDIA - CL 5.4.0
--
Configure an SNMPv3 username SNMPv3_USER on NVIDIA Cumulus switches running CL 5.4.0:
...
.NVIDIA - CL 5.11.0+
--
Configure an SNMPv3 username SNMPv3_USER on NVIDIA Cumulus switches running CLI 5.11.0 and later:
