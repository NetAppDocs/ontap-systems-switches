...
For health monitoring support, these steps are also required if you are using NVIDIA CL 5.11.x with the following ONTAP releases: 
...
NOTE: Using CL 5.11.x with ONTAP versions earlier than the specified releases might result in inconsistent or unexpected health monitoring and log collection behavior.
