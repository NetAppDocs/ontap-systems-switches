...
== New switch support
The following table lists newly supported switches, their descriptions, minimum ONTAP versions, and release dates.

[cols="25h,~,~,~",options="header"]
|===
| Switches| Description| Available beginning | Release date
a|
36-port 400GbE ports Cisco switch with 1 Supervisor module, 7 Fabric modules, and 4 Power Supply Units (PSU) (X-N9K-C9808-B1-A)
a|
Cisco Nexus 9808 switch Intra-Cluster/HA/Storage switch support.
a|
ONTAP 9.19.1
a|
July 2026
...
October 2025
a|
12-port 10/25/40/100GbE Cisco cluster and storage switch (X190212-CS-PE and X190212-CS-PI)
a|
Cisco Nexus 9336C-FX2-T cluster and storage switches. Supports 10/25/40/100GbE cluster configurations and 100GbE storage (switch-attached storage) configurations.
a|
ONTAP 9.10.1
a|
May 2025 (Storage), May 2023 (Cluster)
a|
