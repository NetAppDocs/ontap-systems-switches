...
+
For example, if you are using your switches as shared switches in an AFX 2K system, you use the RCF file appropriate for that use case. The appropriate RCF file could be named similarly to  `RCF-v10.1-NX9364D-GX2A-CL1-ST1-100GBR31-400G31.txt`. The following table shows the preset groups of the switch ports, their port speeds, and usage for this RCF file.
+
[options="header" cols="1,2"]
|===
| Switch port groups | Port speeds and usage
