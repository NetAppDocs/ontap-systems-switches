...
. Download and install the NX-OS software and EPLD image. The steps can vary based on your current NX-OS version and the target NX-OS version. Choose the tab that applies to your situation.
...
.. Skip to step 7 to verify the health of cluster ports and switch health from the cluster after the upgrade.
--

.Upgrade from 10.5(3)(F) to a later version
--

.. Copy NX-OS and EPLD image to the first switch.
+
`copy <protocol>: bootflash: vrf management`
+
...
/code/nxos64-nxos64-cs.10.5.4.M.bin  100% 1261MB   9.3MB/s   02:15
sftp> *exit*
Copy complete, now saving to disk (please wait)...
Copy complete.
....
