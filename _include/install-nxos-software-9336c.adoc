...
. Upgrade the EPLD image and reboot the switch. If you are using NX-OS 10.5(3)F or later, skip to step 12 because the EPLD image is included in the NX-OS image.
+
.Show example
[%collapsible]
====
