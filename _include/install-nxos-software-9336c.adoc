...
NOTE: If you are upgrading from NX-OS 10.5(3) or later, both images are updated at the same time; there is no separate EPLD image to install. Copying the NX-OS image also copies the embedded EPLD image.
