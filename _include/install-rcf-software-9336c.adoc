...
NOTE: See link:configure-software-overview-9336c-cluster.html[Software install workflow] for details of the available RCF configurations.
...
. Repeat steps 4 to 11 on switch cs1.
...
====
+
When using the multi-cluster feature, to verify that your cluster nodes are in their correct cluster vlans, use the commands:
+
----
