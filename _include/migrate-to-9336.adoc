...
. If the cluster LIFs have failed over to switch cs1 and the cluster is healthy, go to <<step_10,Step. 10>>. If some cluster LIFs are not healthy or the cluster is unhealthy,  you can roll back the connectivity to the cs2, as follows:
