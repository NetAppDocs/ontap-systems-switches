...
summary: "Install a Cisco Nexus 3132Q-V cluster switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch."
---
...
[.lead]
Install a Cisco Nexus 3132Q-V cluster switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch.
