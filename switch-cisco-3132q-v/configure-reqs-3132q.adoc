...
summary: "Review the configuration requirements for Cisco Nexus 3132Q-V cluster switches before installation or upgrade."
---
= Review configuration requirements for Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the configuration requirements for Cisco Nexus 3132Q-V cluster switches before installation or upgrade.
...
.Related information
* Refer to the link:https://hwu.netapp.com[Hardware Universe^] for latest information. 
