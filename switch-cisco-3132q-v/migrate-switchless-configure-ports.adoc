...
summary: "Configure ports for migration from a two-node switchless cluster to Cisco Nexus 3132Q-V cluster switches."
---
= Configure ports for migration from switchless clusters to Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Configure ports for migration from a two-node switchless cluster to a two-node switched cluster using Cisco Nexus 3132Q-V cluster switches.
...
.What's next?
After you've configured your switch ports, you can 
