...
Review the Cisco Nexus 5596 requirements in link:switch-requirements.html[Requirements for replacing Cisco Nexus 3132Q-V cluster switches].
...
+
.Example of network interface modify
[%collapsible]
====
----
...
+
.Example of network interface migrate
[%collapsible]
====
...
`network port modify`
+
.Example of network port modify
[%collapsible]
====
...
+
.Example of building temporary ISL
[%collapsible]
====
...
+
.Example of ISL ports brought up
[%collapsible]
====
...
+
.Example of show port-channel summary
[%collapsible]
====
...
+
.Example of network interface revert
[%collapsible]
====
