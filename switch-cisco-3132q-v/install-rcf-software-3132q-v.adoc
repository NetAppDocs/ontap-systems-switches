...
Be sure to complete the procedure in link:prepare-install-cisco-nexus-3132q-v.html[Prepare to install NX-OS and RCF], and then follow the steps below.
...
Go to link:https://docs.netapp.com/us-en/ontap/task_configure_ontap.html[Configure ONTAP on a new cluster with System Manager] for setup instructions.
