...
summary: "Review the migration requirements for moving from a two-node switchless cluster to Cisco Nexus 3132Q-V cluster switches."
---
= Review migration requirements for Cisco Nexus 3132Q-V cluster switches
:imagesdir: ../media/

[.lead]
Review the requirements for migrating from a two-node switchless cluster to a switched cluster using Cisco Nexus 3132Q-V cluster switches. 
