...
summary: "Follow this workflow to install NX-OS software and the RCF on Cisco Nexus 3132Q-V cluster switches."
---
= Software installation workflow for Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install NX-OS software and the reference configuration file (RCF) on Cisco Nexus 3132Q-V cluster switches.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four]link:install-upgrade-rcf-overview-3132q-v.html[Install or upgrade the RCF]
[role="quick-margin-para"]
Install or upgrade the RCF after setting up the Cisco 3132Q-V switch.
