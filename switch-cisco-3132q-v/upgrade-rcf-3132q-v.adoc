...
summary: "Upgrade the reference configuration file (RCF) on Cisco Nexus 3132Q-V cluster switches when a newer version is available."
---
= Upgrade the RCF on Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the reference configuration file (RCF) on Cisco Nexus 3132Q-V cluster switches when a newer version of the RCF is available. 
...
+
NOTE: When upgrading or applying a new RCF, you must erase the switch settings and perform basic configuration.
+
...
. Copy the RCF to the bootflash of switch cs2 using one of the following transfer protocols: FTP, TFTP, SFTP, or SCP. For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html[Cisco Nexus 3000 Series NX-OS Command Reference^].
+
...
+
For more information on Cisco commands, refer to the appropriate guide in the https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html[Cisco Nexus 3000 Series NX-OS Command Reference^].
+
...
+
NOTE: For steps on how to bring your 10GbE ports online after an upgrade of the RCF, refer to the Knowledge Base article link:https://kb.netapp.com/onprem%2FSwitches%2FCisco%2F10GbE_ports_on_Cisco_3132Q_cluster_switch_do_not_come_online[10GbE ports on a Cisco 3132Q cluster switch do not come online^]. 
...
+
For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html[Cisco Nexus 3000 Series NX-OS Command Reference^].
.Show example 
[%collapsible]
====
----
...
. Reapply any previous customizations to the switch configuration. Refer to link:cabling-considerations-3132q-v.html[Review cabling and configuration requirements] for details of any further changes required.
