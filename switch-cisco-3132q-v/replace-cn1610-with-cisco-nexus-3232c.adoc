...
summary: "Migrate from NetApp CN1610 cluster switches to Cisco Nexus 3132Q-V cluster switches without disrupting cluster operation."
---
= Migrate from NetApp CN1610 cluster switches to Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate from NetApp CN1610 cluster switches to Cisco Nexus 3132Q-V cluster switches without disrupting cluster operation.
...
. [[step43_replacecn1610]]If you suppressed automatic case creation, reenable it by invoking an AutoSupport message: 
+
...
// Updates for AFFFASDOC-102, 2023-NOV-28
// Updated as part of AFFFASDOC-216, 217, 2024-JUL-30
// Updates for GH issue #212, 20204-OCT-16
