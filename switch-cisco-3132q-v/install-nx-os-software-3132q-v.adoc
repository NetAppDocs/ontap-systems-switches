...
summary: "Install the NX-OS software on Cisco Nexus 3132Q-V cluster switches to prepare them for cluster operation."
---
= Install NX-OS software on Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the NX-OS software on Cisco Nexus 3132Q-V cluster switches to prepare them for cluster operation.
...
. Copy the NX-OS software to the Nexus 3132Q-V switch using one of the following transfer protocols: FTP, TFTP, SFTP, or SCP. For more information on Cisco commands, refer to the appropriate guide in link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html[Cisco Nexus 3000 Series NX-OS Command Reference^].
+
.Show example
[%collapsible]
====
...
After you've installed the NX-OS software, you can link:install-upgrade-rcf-overview-3132q-v.html[install or upgrade the Reference Configuration File (RCF)].
