...
summary: "Review the documentation required to install and maintain Cisco Nexus 3132Q-V cluster switches."
---
= Review documentation requirements for Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 3132Q-V cluster switches and configure them in an ONTAP cluster.

== Switch documentation
To set up the Cisco Nexus 3132Q-V switches, you need the following documentation from link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html[Cisco Nexus 3000 Series Switches Support^].
...
To install a 3132Q-V Cisco switch in a NetApp cabinet, refer to the following hardware documentation.
...
a|
link:install-cisco-nexus-3132qv.html[Install Cisco Nexus 3132Q-V switch in a NetApp Cabinet^]
a|
