...
* Ensure that you have a current backup of the switch configuration before you perform this procedure.
====
...
. If you do not already have a current backup of the switch, you can save the current switch configuration by capturing the output of the following command to a log file.
+
`show running-config`
