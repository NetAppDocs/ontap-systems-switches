...
The following table lists the available RCFs for 3132Q-V switches. Choose the applicable RCF version for your configuration. See link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] for more information.
...
For details of the available RCF configurations, see link:configure-software-overview-3132q-v-cluster.html[Software install workflow].
