...
After you've reviewed the install RCF or upgrade RCF procedure, you link:install-rcf-software-3132q-v.html[install the RCF] or link:upgrade-rcf-software-3132q-v.html[upgrade your RCF] as required.
