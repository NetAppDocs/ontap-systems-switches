...
summary: "Install or upgrade the RCF on Cisco Nexus 3132Q-V cluster switches after initial setup or when a newer version is available."
---
= Learn about installing or upgrading the RCF on Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 3132Q-V cluster switches after initial setup, or upgrade your RCF version when a newer version is available.
...
The following table lists the available RCFs for 3132Q-V switches. Choose the applicable RCF version for your configuration. Refer to link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] for more information.
...
For details of the available RCF configurations, refer to link:configure-software-overview-3132q-v-cluster.html[Software install workflow].
...
After you've reviewed the install RCF or upgrade RCF procedure, you link:install-rcf-software-3132q-v.html[install the RCF] or link:upgrade-rcf-3132q-v.html[upgrade your RCF] as required.
