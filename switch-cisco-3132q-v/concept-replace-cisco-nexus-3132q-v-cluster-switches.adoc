...
[.lead]
make sure you understand the configuration requirements, port connections and cabling requirements when you replace Cisco Nexus 3132Q-V cluster switches.
