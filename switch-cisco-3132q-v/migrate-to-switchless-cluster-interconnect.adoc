...
summary: "Replace Cisco Nexus 3132Q-V cluster switches with switchless connections for ONTAP 9.3 and later."
---
...
[.lead]
In ONTAP 9.3 and later, migrate from a cluster with switched interconnects to one where two nodes are directly connected by replacing Cisco Nexus 3132Q-V cluster switches with direct connections.
