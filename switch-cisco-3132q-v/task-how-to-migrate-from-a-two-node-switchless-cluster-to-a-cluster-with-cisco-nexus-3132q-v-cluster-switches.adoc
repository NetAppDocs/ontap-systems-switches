...
* The first cluster port moved to C1 (<<step1_migrate_2node3132q, Step 1>>- <<step20_migrate_2node3132q,20>>)
* The second cluster port moved to C2 (<<step21_migrate_2node3132q, Step 21>>- <<step20_migrate_2node3132q,32>>).
* Disable the two-node switchless cluster option (<<step33_migrate_2node3132q, Step 33>>- <<step20_migrate_2node3132q,35>>)
