...
[.lead]
Follow these steps to move your second cluster port to C2.
...
.What's next?
link:migrate-switchless-disable-switchless-option.html[Disable the two-node switchless cluster option].
