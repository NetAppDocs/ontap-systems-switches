...
summary: "Verify that SSH and SSH keys are enabled on Cisco Nexus 3132Q-V cluster switches to support CSHM and log collection."
---
= Verify the SSH configuration for Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Verify that SSH and SSH keys are enabled on Cisco Nexus 3132Q-V cluster switches to support the Ethernet switch health monitor (CSHM) and log collection features.
