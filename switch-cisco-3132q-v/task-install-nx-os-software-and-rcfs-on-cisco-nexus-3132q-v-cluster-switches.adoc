...
---
= Prepare to install configuration files
:icons: font
:imagesdir: ../media/

[.lead]
Learn how to prepare to install the NX-OS software and NX-OS software configuration file and the Reference Configurations File (RCFs).
