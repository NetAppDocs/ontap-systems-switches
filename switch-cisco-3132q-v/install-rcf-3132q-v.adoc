...
+
.Example of system cluster-switch show
[%collapsible]
====
...
----
Ensure that auto-revert is disabled after running this command.
...
`write erase`
+
NOTE: This step requires a console connection to the switch.
+
.Example of write erase
[%collapsible]
====
...
.Example of TFTP being used to copy an RCF to the bootflash on switch cs2
[%collapsible]
====
[subs=+quotes]
----
...
.Example of the RCF file `Nexus_3132QV_RCF_v1.6-Cluster-HA-Breakout.txt` being installed on switch cs2
[%collapsible]
====
[subs=+quotes]
----
...
+
.Example of show banner motd command
[%collapsible]
====
----
...
`network port show -ipspace Cluster`
+
.Example of network port show command
[%collapsible]
====
...
+
.Example of network device-discovery show command
[%collapsible]
====
[subs=+quotes]
----
...
+
.Example of interface example output 
[%collapsible]
====
...
`network interface show -vserver Cluster`
+
.Example of network interface show command 
[%collapsible]
====
...
`cluster show`
+
.Example of cluster show command 
[%collapsible]
====
[subs=+quotes]
----
...
+
.Example of show interface brief | grep up command 
[%collapsible]
====
...
+
.Example of show port-channel summary command 
[%collapsible]
====
...
+
.Example of cluster ping-cluster command 
[%collapsible]
====
...
+
.Example of system switch ethernet log setup-password 
[%collapsible]
====
...
+
.Example of system switch ethernet log enable-collection 
[%collapsible]
====
...
+
.Example of system cluster-switch log setup-password 
[%collapsible]
====
[subs=+quotes]
----
...
+
.Example of system cluster-switch log enable-collection 
[%collapsible]
====
