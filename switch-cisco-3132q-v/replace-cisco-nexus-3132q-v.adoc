...
summary: "Replace a defective Cisco Nexus 3132Q-V cluster switch. This is a nondisruptive procedure."
---
= Replace a Cisco Nexus 3132Q-V cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective Cisco Nexus 3132Q-V cluster switch without disrupting cluster operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and migrating connections from the failed switch.
...
+
link:https://mysupport.netapp.com/site/products/all/details/cisco-cluster-storage-switch/downloads-tab[Cisco Ethernet Switch^] has the latest RCF and NX-OS versions for your switches.
...
* Trigger a maintenance AutoSupport before and after maintenance to disable case creation for the duration of the maintenance. Refer to this Knowledge Base article link:https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU92[SU92: How to suppress automatic case creation during scheduled maintenance windows^] for further details.
...
-
The examples in this procedure use four nodes: Two nodes use four 10 GB cluster interconnect ports: e0a, e0b, e0c, and e0d. The other two nodes use two 40 GB cluster interconnect ports: e4a and e4e. Refer to the link:https://hwu.netapp.com/[Hardware Universe^] for the actual cluster ports on your platforms.
...
You must prepare the replacement switch at this time. If you need to upgrade the RCF and image, you must follow these steps:
 ...
 .. On the NetApp Support Site, refer to link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch/[Cisco Ethernet Switches^].
...
[start=9]
. [[step9]]Shut down the ports 1/31 and 1/32 on CL1, and the active Nexus 3132Q-V switch:
+
`shutdown`
+
.Show example
...
.What's next?
After you've replaced your switch, you can
link:../switch-cshm/config-overview.html[configure switch health monitoring].

// QA clean-up, 2022-03-03
// Updated as part of AFFFASDOC-216, 217, 20024-JUL-30
