...
-
The examples in this procedure use four nodes: Two nodes use four 10 GB cluster interconnect ports: e0a, e0b, e0c, and e0d. The other two nodes use two 40 GB cluster interconnect ports: e4a and e4e. Refer to link:https://hwu.netapp.com/[Hardware Universe^] for the actual cluster ports on your platforms.
