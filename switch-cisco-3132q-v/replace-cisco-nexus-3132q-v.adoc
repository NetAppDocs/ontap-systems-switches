...
summary: "Replacing a defective Cisco Nexus 3132Q-V switch in a cluster network is a nondisruptive procedure NDU, and you must perform a specific sequence of tasks."
---
