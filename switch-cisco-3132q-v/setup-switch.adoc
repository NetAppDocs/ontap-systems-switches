...
+
For more information, see the _Documentation requirements_ section in link:index.html[Overview and requirements].
...
* Completed cabling worksheets. See link:setup_worksheet_3132q.html[Cisco Nexus 3132Q-V cabling worksheet].

* Applicable NetApp cluster network and management network RCFs, which you can download from the NetApp Support Site at http://mysupport.netapp.com/[mysupport.netapp.com^] for the switches that you receive. All Cisco cluster network and management network switches arrive with the standard Cisco factory-default configuration. These switches also have the current version of the NX-OS software, but do not have the RCFs loaded.
...
. Cable the cluster network and management network switches to the controllers using the completed link:switch-cisco-3132q-v/setup_worksheet_3132q.html[Cabling worksheet].
