...
summary: "Complete the migration from a two-node switchless cluster to Cisco Nexus 3132Q-V cluster switches."
---
= Complete the migration from a two-node switchless cluster to Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Complete the final steps to migrate from a two-node switchless cluster to a two-node switched cluster using Cisco Nexus 3132Q-V cluster switches. 
