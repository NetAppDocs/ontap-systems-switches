...
summary: "Complete the cabling worksheet for Cisco Nexus 3132Q-V cluster switches to document port connections and supported platform configurations."
---
= Complete the Cisco Nexus 3132Q-V cabling worksheet
:icons: font
:imagesdir: ../media/

[.lead]
Complete the cabling worksheet for Cisco Nexus 3132Q-V cluster switches to document port connections and supported platform configurations. 
...
.What's next
After you've completed your cabling worksheets, you link:install-switch-3132qv.html[install the switch].
