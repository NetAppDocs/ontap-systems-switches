...
summary: "Prepare to migrate from a two-node switchless cluster to Cisco Nexus 3132Q-V cluster switches."
---
= Prepare to migrate from a switchless cluster to Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Prepare your two-node switchless cluster for migration to a switched cluster using Cisco Nexus 3132Q-V cluster switches. 
