---
permalink: switch-cisco-3132q-v/install-cisco-nexus-3232c.html
sidebar: sidebar
...
Review the initial preparation requirements, kit contents, and safety precautions in the http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html[Cisco Nexus 3000 Series Hardware Installation Guide^]
