...
* If you have just upgraded your Cumulus Linux version, you do not need to disable auto-revert for this step, since it is already disabled.
=========================================
...
+
`cluster show`
. Repeat steps 1 to 14 on the 2nd switch.
