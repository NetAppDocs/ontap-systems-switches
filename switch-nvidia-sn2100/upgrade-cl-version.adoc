...
[subs=+quotes]
----
cumulus@cumulus_cs1:mgmt:~$ *nv set interface eth0 ip address 10.231.80.206*
...
[subs=+quotes]
----
cumulus@cumulus_cs1:mgmt:~$ *sudo adduser --ingroup netedit admin*
[sudo] password for cumulus:
Adding user `admin’ ...
...
[subs=+quotes]
----
cumulus@cumulus_cs1:mgmt:~$ *sudo adduser admin nvshow*
     [sudo] password for cumulus:
