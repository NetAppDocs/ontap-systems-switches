...
* Specify a user in the RCF (in addition to the admin user) to be used specifically for log collection. 
* Enable switch health monitoring on the switch in order to run the log collection feature. 
