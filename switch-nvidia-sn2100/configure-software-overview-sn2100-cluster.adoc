...
summary: "Follow this workflow to install Cumulus Linux and the RCF on NVIDIA SN2100 cluster switches."
---
= Software installation workflow for NVIDIA SN2100 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install Cumulus Linux and the reference configuration file (RCF) on NVIDIA SN2100 cluster switches.
