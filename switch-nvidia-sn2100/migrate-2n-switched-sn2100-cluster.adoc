...
+
IMPORTANT: Refer to link:cabling-considerations-sn2100-cluster.html[Review cabling and configuration considerations] for caveats and further details. link:https://hwu.netapp.com/SWITCH/INDEX[Hardware Universe - Switches^] also contains more information about cabling.
...
+
link:https://hwu.netapp.com[Hardware Universe^] contains the latest information about the actual cluster ports for your platforms.
