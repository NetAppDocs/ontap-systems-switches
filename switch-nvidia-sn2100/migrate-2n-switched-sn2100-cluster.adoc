...
+
IMPORTANT: Refer to link:cabling-considerations-sn2100-cluster.html[Review cabling and configuration guidelines] for caveats and further details. The link:https://hwu.netapp.com/SWITCH/INDEX[Hardware Universe - Switches^] also contains more information about cabling.
