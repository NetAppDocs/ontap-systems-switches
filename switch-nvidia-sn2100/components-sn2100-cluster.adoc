...
NOTE: See the NVIDIA documentation for details on link:https://docs.nvidia.com/networking/display/sn2000pub/Installation[installing your SN2100 switch and rail kit^].
