...
summary: "Migrate existing NetApp CN1610 cluster switches to NVIDIA SN2100 cluster switches without disrupting cluster operation."
---
= Migrate from NetApp CN1610 cluster switches to NVIDIA SN2100 cluster switches
//= Migrate from a Cisco cluster switch to a NVIDIA SN2100 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Migrate existing NetApp CN1610 cluster switches to NVIDIA SN2100 cluster switches without disrupting cluster operation.

== Review requirements

You must be aware of certain configuration information, port connections and cabling requirements when you are replacing NetApp CN1610 cluster switches with NVIDIA SN2100 cluster switches. Refer to link:configure-overview-sn2100-cluster.html[Overview of installation and configuration for NVIDIA SN2100 switches].
