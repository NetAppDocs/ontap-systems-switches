...
summary: "Migrate from older Cisco storage switches to NVIDIA SN2100 storage switches without disrupting storage network operation."
---
= Migrate from a Cisco storage switch to an NVIDIA SN2100 storage switch
:icons: font
:imagesdir: ../media/

[.lead]
Migrate from older Cisco storage switches to NVIDIA SN2100 storage switches without disrupting storage network operation.

== Review requirements

You must be aware of certain configuration information, port connections and cabling requirements when you are replacing some older Cisco switches with NVIDIA SN2100 storage switches. Refer to link:configure-overview-sn2100-cluster.html[Overview of installation and configuration for NVIDIA SN2100 switches].
