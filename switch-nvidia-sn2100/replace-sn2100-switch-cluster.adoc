...
summary: "Replace a defective NVIDIA SN2100 cluster switch in a cluster network. This is a nondisruptive procedure."
---
= Replace an NVIDIA SN2100 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective NVIDIA SN2100 cluster switch in a cluster network without disrupting cluster operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and migrating connections from the failed switch.
