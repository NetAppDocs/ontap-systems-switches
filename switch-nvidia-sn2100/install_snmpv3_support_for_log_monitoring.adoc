---
permalink: switch-nvidia-sn2100/install_snmpv3_support_for_log_monitoring.html
sidebar: sidebar
keywords: sn2100 SN2100 cabling setup, sn2100 switches configuration, cumulus linux os
summary: 'This release includes support for SNMPv3 for log monitoring.'
---
= SNMPv3 support for log monitoring
:icons: font
:imagesdir: ../media/

[.lead]
This release includes support for SNMPv3 for log monitoring.

.About this task
The following commands are used:

* For *No AUTH*:
`net add snmp-server username [USER] auth-none`
* For *Only AUTH*:
`net add snmp-server username [USER] [auth-md5/auth-sha] [AUTH-PASSWORD]`
* For *AUTH and PRIV*:
`net add snmp-server username [USER] [auth-md5/auth-sha] [AUTH-PASSWORD] [encrypt-aes/encrypt-des] [PRIV-PASSWORD]`

.Steps
. Setup the SNMP user on the switch to use AUTH and PRIV:
+
[subs=+quotes]
----
...
---------------------------------  ----------------
cumulus@sw1:~$
cumulus@sw1:~$ *net add snmp-server username cumulus auth-md5 netapp1! encrypt-aes netapp1!*
...
+createuser cumulus MD5 netapp1! AES netapp1!
...
-------  --------------------------  -----------------------------------------------------------------------------
cumulus  2020-08-11 00:13:51.826987  net add snmp-server username cumulus auth-md5 netapp1! encrypt-aes netapp1!
...
[subs=+quotes]
----
cluster1::*> *security login create -user-or-group-name cumulus -application snmp -authentication-method usm -remote-switch-ipaddress 10.231.80.212*
...
cluster1::*>
cluster1::*> *system switch ethernet modify -device "sw1 (b8:59:9f:09:7c:22)" -snmp-version SNMPv3 -community-or-username cumulus*
----
...
cluster1::*> *system switch ethernet show-all -device "sw1 (b8:59:9f:09:7c:22)" -instance*
                                 ...
                                 Is Discovered: true
DEPRECATED-Community String or SNMPv3 Username: -
           Community String or SNMPv3 Username: cumulus
                                  Model Number: MSN2100-CB2FC
                                Switch Network: cluster-network
                              Software Version: Cumulus Linux version 4.4.3 running on Mellanox Technologies Ltd. MSN2100
                     Reason For Not Monitoring: None
