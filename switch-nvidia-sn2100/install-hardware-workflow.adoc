...
summary: "Follow this workflow to install the hardware for NVIDIA SN2100 cluster switches."
---
= Hardware installation workflow for NVIDIA SN2100 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure the hardware for NVIDIA SN2100 cluster switches.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png[Two]link:cabling-considerations-sn2100-cluster.html[Review cabling and configuration guidelines]
[role="quick-margin-para"]
