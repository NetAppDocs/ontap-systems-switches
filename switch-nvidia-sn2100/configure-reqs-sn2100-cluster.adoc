...
* Cumulus Linux (CL) OS version. To download the SN2100 Cumulus software, log into the https://enterprise-support.nvidia.com/s/[NVIDIA Enterprise Support Portal^] Note that you must have log in credentials to access the Cumulus software. For current compatibility information, see the https://mysupport.netapp.com/site/info/nvidia-cluster-switch[NVIDIA Ethernet Switches^] information page.
