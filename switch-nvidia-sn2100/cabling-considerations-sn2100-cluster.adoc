...
Cumulus Linux 5.4 and later includes support for fast link-up with Pensando cards and support for copper cables. You can install the new version and configure the links using the `nv set` command as follows:
+
[subs=+quotes]
----
