...
summary: "Review the cabling and configuration considerations for NVIDIA SN2100 cluster switches before deployment."
---
= Review cabling and configuration considerations for NVIDIA SN2100 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the cabling and configuration considerations for NVIDIA SN2100 cluster switches before deployment. 
...
Refer to the link:https://hwu.netapp.com/Switch/Index[Hardware Universe^] for more information on switch ports.
...
Refer to the Knowledge Base article link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Systems/Fabric_Interconnect_and_Management_Switches/NVIDIA_SN2100_switch_fails_to_connect_using_40_100GbE_copper_cable[SN2100 switch fails to connect using 40/100GbE copper cables^] for further details.
...
.What's next?
After you've reviewed your cabling and configuration requirements, you can link:install-cable-shelves-sn2100-cluster.html[cable the NS224 shelves as switch-attached storage].
...
// AFFFASDOC-276, AFFFASDOC-249, 2025-DEC-09
