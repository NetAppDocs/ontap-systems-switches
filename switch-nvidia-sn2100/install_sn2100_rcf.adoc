...
/home/cumulus
cumulus@cumulus:mgmt: */tmp$ scp ssologin@_<file_location>_/MSN2100-RCF-v1.8-Cluster*
ssologin@_<ip_address>_'s password:
...
.. Reboots the switch
+
NOTE: If the RCF python script fails at any stage, contact https://mysupport.netapp.com/[NetApp support^] for assistance.
