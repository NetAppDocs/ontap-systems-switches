...
summary: "Reset the NVIDIA SN2100 cluster switch to factory defaults by erasing the current switch configuration."
---
= Reset the NVIDIA SN2100 cluster switch to factory defaults

:icons: font
:imagesdir: ../media/

[.lead]
Reset the NVIDIA SN2100 cluster switch to factory defaults by erasing the current switch configuration and restoring the switch to its original settings.
...
NOTE: For more information about installing Cumulus Linux, refer to link:configure-software-overview-sn2100-cluster.html[Software install workflow for NVIDIA SN2100 switches].
...
Refer to the NVIDIA link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/[Factory Reset^] documentation for further details.

--
====

.What's next
After you've reset your switches, you can link:configure-overview-sn2100-cluster.html[reconfigure] them as needed.
