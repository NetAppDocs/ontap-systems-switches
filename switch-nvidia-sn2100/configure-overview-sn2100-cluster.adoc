...
summary: "Follow this workflow to install and configure NVIDIA SN2100 cluster switches in an ONTAP environment."
---
= Installation and setup workflow for NVIDIA SN2100 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure NVIDIA SN2100 cluster switches in an ONTAP environment. The SN2100 is a 10/25/40/100 GbE switch running Cumulus Linux that supports ONTAP clusters with more than two nodes.

Follow these workflow steps to install and set up your NVIDIA SN2100 switches.
