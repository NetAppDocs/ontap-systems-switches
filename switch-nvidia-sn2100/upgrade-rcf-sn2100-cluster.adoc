...
summary: "Upgrade the reference configuration file (RCF) script on NVIDIA SN2100 cluster switches when a newer version is available."
---
= Upgrade the RCF script on NVIDIA SN2100 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the reference configuration file (RCF) script on NVIDIA SN2100 cluster switches when a newer version is available.

.Before you begin
Before upgrading the RCF script, make sure that the following are available on the switch:
...
// New content for AFFFASDOC-202, 2025-MAR-12
