...
summary: "Migrate from a two-node switchless cluster to a switched cluster environment using NetApp CN1610 cluster switches."
---
= Migrate from a switchless cluster to a switched NetApp CN1610 cluster environment
:icons: font
:imagesdir: ../media/

[.lead]
Migrate from a two-node switchless cluster environment to a switched cluster environment using NetApp CN1610 cluster switches. This migration enables you to scale the cluster beyond two nodes.
