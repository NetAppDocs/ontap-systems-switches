...
summary: "Install the FASTPATH software on NetApp CN1610 cluster switches, beginning the upgrade with the second switch (cs2)."
---
= Install FASTPATH software on NetApp CN1610 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the FASTPATH software on NetApp CN1610 cluster switches, beginning the upgrade with the second switch, _cs2_.
