...
. Repeat link:install-fastpath-software.html[Step 1: Migrate cluster], link:install-fastpath-software.html[Step 2: Install FASTPATCH software] and link:install-fastpath-software.html[Step 3: Validate installation] to install the FASTPATH software on the other switch, cs1.
