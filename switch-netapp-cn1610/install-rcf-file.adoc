...
summary: "Install a reference configuration file (RCF) on the NetApp CN1610 cluster switch to configure port assignments and network settings."
---
= Install a reference configuration file on the NetApp CN1610 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Install a reference configuration file (RCF) on the NetApp CN1610 cluster switch. Migrate the cluster LIFs away from switch cs2 before installing the RCF, then migrate them back after the RCF is validated. 
