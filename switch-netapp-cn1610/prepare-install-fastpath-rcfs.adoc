...
summary: "Prepare a NetApp CN1610 cluster switch before installing FASTPATH software and reference configuration files (RCFs)."
---
= Prepare to install FASTPATH software and RCFs on a NetApp CN1610 cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Prepare a NetApp CN1610 cluster switch before installing FASTPATH software and reference configuration files (RCFs).
