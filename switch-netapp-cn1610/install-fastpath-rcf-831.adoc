...
summary: "Install FASTPATH software and reference configuration files (RCFs) on NetApp CN1610 cluster switches for ONTAP 8.3.1 and later."
---
= Install FASTPATH software and RCFs on NetApp CN1610 cluster switches for ONTAP 8.3.1 and later
:icons: font
:imagesdir: ../media/

[.lead]
Install FASTPATH software and reference configuration files (RCFs) on NetApp CN1610 cluster switches for ONTAP 8.3.1 and later.
