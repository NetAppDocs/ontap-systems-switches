...
summary: "Replace a defective NetApp CN1610 cluster switch. This is a nondisruptive procedure."
---
...
[.lead]
Replace a defective NetApp CN1610 cluster switch in a cluster network without disrupting cluster operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and migrating connections from the failed switch.
...
. Verify that the switch and ONTAP versions match in the compatibility matrix. Refer to link:https://mysupport.netapp.com/site/info/netapp-cluster-switch[NetApp CN1601 and CN1610 Switches^] for details. 

. From the link:https://mysupport.netapp.com/site/products/all/details/netapp-cluster-switches/downloads-tab[Software Downloads page^] on the NetApp Support Site, select NetApp Cluster Switches to download the appropriate RCF and FASTPATH versions.
