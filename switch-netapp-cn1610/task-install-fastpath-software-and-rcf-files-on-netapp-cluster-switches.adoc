...
+
There can be command dependencies between command syntax in the RCF and FASTPATH versions. The link:http://mysupport.netapp.com/NOW/download/software/cm_switches_ntap/[NetApp CN1601 and CN1610 Switches^] page lists the supported versions.
...
+
The link:https://hwu.netapp.com/[Hardware Universe^] contains the actual cluster ports supported on your platform.
