...
summary: "Migrate FAS22xx systems from a switchless cluster with a single cluster-network connection to a switched cluster using NetApp CN1610 cluster switches."
---
= Migrate FAS22xx systems to a switched cluster using NetApp CN1610 cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate FAS22xx systems from a two-node switchless cluster with a single 10 GbE connection per controller to a switched cluster using NetApp CN1610 cluster switches.
