...
summary: 'If you have an existing two-node switchless cluster environment, you can migrate to a two-node switched cluster environment using Cisco Nexus 9332D-GX2B switches to enable you to scale beyond two nodes in the cluster.'
---
...
[.lead]
If you have an existing two-node _switchless_ cluster environment, you can migrate to a two-node _switched_ cluster environment using Cisco Nexus 9332D-GX2B switches.
...
** Refer to the https://hwu.netapp.com[Hardware Universe^] for all supported ONTAP versions.
...
+
Refer to the https://hwu.netapp.com[Hardware Universe^] for more information about cabling.
...
Refer to the https://hwu.netapp.com[Hardware Universe^] for information about the cluster ports for your platforms. Refer to link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?^] for more information about switch installation requirements.
