...
[.lead]
If you are installing new Cisco Nexus 9332D-GX2B switches as part of a new AFX A1K or AFX A2K system installation, replacing a faulty switch, or resetting a switch to the factory defaults settings, you must prepare your switch(es) and AFX system before installing NX-OS and the Reference Configuration File (RCF) on the switch(es).

Preparing your switches and AFX system includes downloading the current version of NX-OS, downloading the supported version of RCF, suppressing automatic case creation, checking the status of each port, verifying the connectivity of the remote cluster interfaces, and verifying that the auto-revert command is enabled on all cluster LIFs.
...
After you've prepared to install NX-OS and RCF on your switches, you install NX-OS using the link:install-nxos-software-9332d-cluster-test.html[Install or upgrade NX-OS] procedure.
