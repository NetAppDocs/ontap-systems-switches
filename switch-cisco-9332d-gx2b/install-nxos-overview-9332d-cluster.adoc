...
After you've prepared to install NX-OS and RCF on your switches, you install NX-OS using the link:install-nxos-software-9332d-cluster.html[Install or upgrade the NX-OS and RCF procedure].
