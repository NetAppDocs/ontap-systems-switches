...
* You must have access to an HTTP, FTP, or TFTP server. Access to one of these servers allows you to download the current NX-OS and supportedRCF as instructed later in this procedure.
...
** For switches in an AFX-A1K system, NX-OS 10.4.2 and RCF 10.0 are the only supported versions.

** For switches in an AFX-A2K system, NX-OS 10.4.X and RCF 10.1 are the only supported versions at initial release.
...
* Understand that NX-OS should always be installed or upgraded before the RCF.
