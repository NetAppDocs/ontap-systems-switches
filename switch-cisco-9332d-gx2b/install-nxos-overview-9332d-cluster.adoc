...
* Hey: the following is frm the RCF upgrade Before you begin and suggests that this content applies to installing NX-OS and installing RCF too. Need to check with Andris and Sunil.
+
...
After you've prepared to install NX-OS and RCF on your switches, you install NX-OS using the link:install-nxos-software-9332d-cluster-test.html[Install or upgrade the NX-OS and RCF procedure].
