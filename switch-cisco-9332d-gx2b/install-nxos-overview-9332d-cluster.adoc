...
After you've prepared to install NX-OS and RCF, you link:install-nxos-software-9332d-cluster.html[install NX-OS] using the Install or upgrade the NX-OS and RCF procedure.
