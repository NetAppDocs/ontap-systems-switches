...
summary: If you are installing new Cisco Nexus 9332D-GX2B switches as part of a new AFX A1K or AFX A2K system installation, replacing a faulty switch, or resetting a switch to the factory defaults settings, you must prepare your switch(es) and AFX system before installing NX-OS and Reference Configuration File (RCF) on the switch(es).
---
= Prepare to install NX-OS and RCF - Cisco Nexus 9332D-GX2B
...
.Before you begin
* The switches must be powered on and you must have completed the link:setup-switch-9332d-cluster.html[initial switch setup] procedure.

* You must have access to an HTTP, FTP, or TFTP server. Access to one of these servers allows you to download the supported NX-OS and RCF as instructed later in this procedure.

* Hey: the following is from the RCF upgrade Before you begin and suggests that this content applies to installing NX-OS and installing RCF too. Need to check with Andris and Sunil.
+
...
.About this task
* The type of AFX system your switches are in determines the supported versions of NX-OS and RCF for your switches.

** For switches in an AFX A1K system, running any supported version of ONTAP, NX-OS 10.4.2 and RCF 10.0 are the only supported versions.

** For switches in an AFX A2K system, running ONTAP 9.19.1GA or later, NX-OS 10.6 and RCF 10.1 are the only supported versions at the initial release of ONTAP 9.19.1GA.
+
...
+
NOTE: New switches do not ship with the RCFs installed. You must install the RCFs on the switches.
...
After you've prepared to install NX-OS and RCF on your switches, you install NX-OS using the link:install-nxos-software-9332d-cluster-test.html[Install or upgrade the NX-OS] procedure.

//Understand that NX-OS should always be installed or upgraded before RCF.
