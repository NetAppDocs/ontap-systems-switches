...
. Hard-code the switch breakout (4x100GbE) ports for 100GbE. If you do not hard-code the speed on the ports you designated as breakout ports, the ports will not come up and will be in an error-disabled state.
+
`speed 100000`
+
`no negotiate auto`
