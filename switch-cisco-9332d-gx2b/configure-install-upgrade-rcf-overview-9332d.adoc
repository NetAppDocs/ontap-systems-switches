...
summary: "Install or upgrade the RCF on Cisco Nexus 9332D-GX2B switches for AFX 1K and AFX 2K system installations, switch replacements, or to support new hardware or ONTAP versions."
---
...
[.lead]
Install or upgrade the reference configuration file (RCF) on Cisco Nexus 9332D-GX2B switches. Install a new RCF for AFX 1K or AFX 2K system installations or switch replacements, or upgrade an existing RCF to support new hardware or ONTAP versions.
