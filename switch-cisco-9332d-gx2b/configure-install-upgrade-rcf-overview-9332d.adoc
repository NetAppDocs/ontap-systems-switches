...
+
For example, to hard-code 100GbE on breakout ports 15-19, do the following. The example shows commands being applied to the first switch (cs1). You repeat these commands for the second switch.
+
`speed 100000`
+
`no negotiate auto`
