...
However, if your switches are in an AFX-A2K system, and they have RCF version 10.1, you can link:change-port-speed.html[change the default port speed configuration] if needed, and then link:configure-ssh-keys.html[verify SSH and SSH keys are enabled].
