...
Note: Apr 25 Lisa: I believe I also need the option tab/some way to talk about the two different version of RCF like in the install RCF topic: If you're using 9223/9364 on 1K system, you use RCF version xxx (like today). If using these switches on 2K, you use the new RCF version xxx.
