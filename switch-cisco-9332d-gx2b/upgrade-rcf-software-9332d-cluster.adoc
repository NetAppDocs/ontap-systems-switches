...
summary: You upgrade the Reference Configuration File (RCF) version on your Cisco Nexus 9332D-GX2B switches to support new hardware, a new ONTAP version, or to align with a new NX-OS version in your AFX A1K or AFX A2K system configuration.
---
...
[.lead]
You upgrade the Reference Configuration File (RCF) version on your Cisco Nexus 9332D-GX2B switches to support new hardware, a new ONTAP version, or to align with a new NX-OS version in your AFX A1K or AFX A2K system configuration.
...
//Need to keep 10.2 reference for A1K users running an earlier version?
...
+
If you have an AFX A2K system (which supports RCF 10.1 and later), you can link:https://review.docs.netapp.com/us-en/ontap-systems-switches_hotfix-refactor-phase1/switch-cisco-9332d-gx2b/install-upgrade-rcf-overview-cluster.html#change-port-speed-configuration-for-afx-a2k-systems[change the port speed configuration] for RCF 10.1 as needed.
...
//However, if your switches are running RCF 10.1 (only supported in an AFX A2K system), you can link:change-port-speed.html[change the default port speed configuration] if needed, and then you link:configure-ssh-keys.html[verify SSH and SSH keys are enabled].
