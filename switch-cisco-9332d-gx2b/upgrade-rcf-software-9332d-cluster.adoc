...
+
If you have an AFX A2K system (which supports RCF 10.1 and later), you can link:change-port-speed-9332d-cluster.html[change the port speed configuration] for RCF 10.1 as needed.
