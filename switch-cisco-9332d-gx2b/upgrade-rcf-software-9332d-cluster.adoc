...
** For switches in an AFX 1K system, running any supported version of ONTAP, RCF 10.0 is the only supported version.

** For switches in an AFX 2K system, running ONTAP 9.19.1GA or later, RCF 10.1 is the only supported version at the initial release of ONTAP 9.19.1GA.
+
...
* The examples shown in this procedure are for AFX 1K systems with switches running NX-OS 10.4.2 and RCF 10.0. If you have an AFX 2K system, the input and output will vary.
