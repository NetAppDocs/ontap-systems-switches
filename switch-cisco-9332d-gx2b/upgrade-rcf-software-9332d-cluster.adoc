...
+
If your switches have RCF 10.1 or later installed, you can link:https://review.docs.netapp.com/us-en/ontap-systems-switches_hotfix-refactor-phase1/switch-cisco-9332d-gx2b/install-upgrade-rcf-overview-cluster.html#change-port-speed-configuration-for-afx-a2k-systems[change the port speed configuration] if needed.
