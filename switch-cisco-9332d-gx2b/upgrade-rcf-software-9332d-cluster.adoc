...
+
HEY, the above bullet is in today's 9332 Update RCF topic. The way it's worded sounds like it only applies to installing NX-OS and installing RCF. Is this "requireemnt" needed in this upgrade RCF topic or elsewhere?
