...
.Before you begin
* The switches must be powered on and you must have completed the link:setup-switch-9332d-cluster.html[Complete initial switch setup] procedure.
...
After you've prepared to install the NX-OS and RCF on your switches, you install the NX-OS using the link:install-nxos-software-9332d-cluster-test.html[Install or upgrade the NX-OS] procedure.
