---
permalink: switch-cisco-9332d-gx2b/configure-prepare-install-nxos-rcf-9332d.html
sidebar: sidebar
...
summary: To install the NX-OS and RCF on your Cisco Nexus 9332D-GX2B switch(es), as part of a new AFX 1K or AFX 2K system installation, switch replacement, or switch reset to factory defaults settings, you must first prepare your switch(es) and AFX system.
---
= Prepare to install the NX-OS and RCF - Cisco Nexus 9332D-GX2B

:icons: font
:imagesdir: ../media/

[.lead]
To install the NX-OS and RCF on your Cisco Nexus 9332D-GX2B switch(es), as part of a new AFX 1K or AFX 2K system installation, switch replacement, or switch reset to factory defaults settings, you must first prepare your switch(es) and AFX system.

//If you are installing new Cisco Nexus 9332D-GX2B switches as part of a new AFX 1K or AFX 2K system installation, replacing a faulty switch, or resetting a switch to the factory defaults settings, you must first prepare your switch(es) and AFX system.

Preparing your switches and AFX system includes downloading the current version of the NX-OS, downloading the supported version of the RCF, suppressing automatic case creation, checking the status of each port, verifying the connectivity of the remote cluster interfaces, and verifying that the auto-revert command is enabled on all cluster LIFs.

//Before you install the NX-OS and Reference Configuration File (RCF) on Cisco Nexus 9332D-GX2B switches, you prepare by downloading the current version of NX-OS if needed, downloading the supported RCF version, suppressing automatic case creation, checking the status of each port, verifying the connectivity of the remote cluster interfaces, and verifying that the auto-revert command is enabled on all cluster LIFs.
...
//* Verify that the version of software on your switch(es) is the current/10.4.2 version.
//+
//If needed, download the NetApp-supported version of the software to the switches from the https://software.cisco.com/download/home[Cisco software download^] page.
//+
//NOTE: New switches should ship with the current version of the NX-OS software.
//+
//Hey,I think I meant for this to be a step along with step to download the RCF. And if only sw 10.4.2 is supported, then how come there's any text anywhere saying to have the current version?

.About this task
* The type of AFX system your switches are in and version of ONTAP your system is running determines the supported versions of NX-OS and RCF for your switches.
+
...
+
NOTE: Do not upgrade or downgrade your NX-OS or RCF version to an unsupported version.

//** For switches in an AFX 1K system, running any supported version of ONTAP, NX-OS 10.4.2 and RCF 10.0 are the only supported versions.

//** For switches in an AFX 2K system, running ONTAP 9.19.1GA or later, NX-OS 10.6 and RCF 10.1 are the only supported versions at the initial release of ONTAP 9.19.1GA.

* This procedure requires the use of both ONTAP commands and Cisco Nexus 9000 Series Switches commands; ONTAP commands are used unless otherwise indicated.
...
* The examples shown in this procedure are for AFX 1K systems with switches running RCF 10.0. If you have an AFX 2K system, the output will vary.

.Steps

//. Verify the supported versions of NX-OS and RCF for your AFX system.
//+
//AFX-A1K systems, at initial release, support NX-OS 10.4.2 and RCF 10.0. 
//+
//AFX-A2K systems, at initial release, support NX-OS 10.4.X and RCF 10.1.
//+
...
... Display how many cluster interconnect interfaces are configured in each node for each switch: 
+
[source,cli]
----
...
... Display information about the cluster LIFs: 
+
[source,cli]
----
...
... Display information about the HA ports: 
+
...
... Display information about the storage ports: 
+
[source,cli]
----
...
After you've prepared to install the NX-OS and RCF on your switches, you install the NX-OS using the link:configure-install-upgrade-nxos-9332d.html[Install or upgrade the NX-OS] procedure.

Or, if keeping the new topic: After you've prepared to install the NX-OS and RCF on your switches, you link:configure-review-cabling-config-requirements-9332d.html[review cabling and configuration requirements].

//Understand that the NX-OS should always be installed or upgraded before the RCF.
