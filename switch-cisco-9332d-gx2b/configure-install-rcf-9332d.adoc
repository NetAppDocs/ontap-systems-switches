...
For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/td/docs/dcn/nx-os/nexus9000/102x/command-reference/config/b_n9k_config_commands_1021.html[Cisco Nexus 9000 Series NX-OS Command Reference^].
+
The following command shows the RCF file `NX9332D-GX2B-RCF-v10.0-Shared.txt` being installed on switch cs1:
+
[subs=+quotes]
----
...
----
+
NOTE: For RCF 10.1 and later, the file name format is different. For example, `RCF-v10.1-NX9332D-GX2B-CL1-ST1-100GB15-400G15.txt` is for a shared switch with ports designated for breakout and 400GbE.
+
