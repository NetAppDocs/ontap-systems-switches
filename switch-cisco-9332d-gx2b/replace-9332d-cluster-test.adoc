...
link:../switch-cisco-9332d-gx2b/configure-ssh-keys.html[Verify SSH is enabled] so that you can configure switch health monitoring (CSHM).

link:../switch-cshm/cshm-overview.html[Configure switch health monitoring (CSHM)] to ensure the operational health of network switches and collect switch logs for debugging purposes.
