---
permalink: switch-cisco-9332d-gx2b/replace-9332d-cluster-test.html
sidebar: sidebar
...
+
link:../switch-cisco-9332d-gx2b/install-nxos-software-9332d-cluster-test.html[Install or upgrade the NX-OS] on the switch.
+
link:../switch-cisco-9332d-gx2b/install-upgrade-rcf-overview-cluster.html[Install the RCF] on the switch.
