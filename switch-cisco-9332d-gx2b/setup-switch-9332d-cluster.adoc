...
---
= Configure a switch - Cisco Nexus 9332D-GX2B
:icons: font
:imagesdir: ../media/

[.lead]
After you install Cisco Nexus 9332D-GX2B switches as part of your AFX system installation or a switch replacement, you need to configure the switch(es).

.Before you begin

* Make sure you have completed the https://docs.netapp.com/us-en/ontap-afx/install-setup/power-on-configure-switch.html[Power on and configure the switch] procedure for each switch in your cluster (AFX system?).
+
Lisa: note that the above topic in the AFX repo links back to my Configure sw and RCF workflow topic, which has users complete all sw, RCF, SSH, health monitor and SCH, THEN links back to AFX repo to pwr on the system. 
