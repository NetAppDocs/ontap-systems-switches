...
* If you are replacing a switch in an existing AFX system, make sure you have completed the https://docs.netapp.com/us-en/ontap-afx/install-setup/replace-switch.html[Replace a switch] procedure.

* If you are resetting a switch to its factory default settings, make sure you have completed the https://docs.netapp.com/us-en/ontap-afx/install-setup/reset-switch-factory-default.html[Reset a switch to factory default settings] procedure.
...
After you've completed the initial switch setup, you link:install-nxos-overview-9332d-cluster.html[prepare to install the NX-OS software and RCF].
