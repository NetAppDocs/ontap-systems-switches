...
** Initial customization of the switch is complete, as detailed in link:configure-complete-initial-setup-switch-9332d.html[Complete initial switch setup].
+
...
+
Lisa: If needed, you can reference the configuration wizard questions and recommended responses in the link:setup-switch-9332d-cluster.html[Complete initial switch setup] procedure.
