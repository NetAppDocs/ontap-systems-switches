...
summary: "Replace a defective Cisco Nexus 9332D-GX2B switch in an AFX system without disrupting operation. This is a nondisruptive procedure."
---
= Replace a Cisco Nexus 9332D-GX2B switch in an AFX system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective Cisco Nexus 9332D-GX2B switch in an AFX system without disrupting operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and restoring the system configuration.
