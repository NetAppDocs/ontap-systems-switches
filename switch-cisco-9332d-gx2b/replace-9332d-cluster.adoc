...
. Shut down the ISL ports 1/31 and 1/32 on the Nexus 9332D-GX2B switch cs1.
+
.Show example 
[%collapsible]
====
...
[%collapsible]
====
This example enables ISL ports 1/31 and 1/32 and displays the port channel summary on switch cs1:
