...
* The node names are node1-01 and node1-02.
//* The cluster ports on each node are named e0a and e0b.
* The cluster LIF names are node1-01_clus1 and node1-01_clus2 for node1-01, and node1-02_clus1 and node1-02_clus2 for node1-02.
