...
summary: For Cisco Nexus 9332D-GX2B switch installation and configuration part of a new AFX A1K or AFX A2K system or maintenance of existing switches, you can reference the applicable Cisco switch documentation and ONTAP systems documentation.
---
...
[.lead]
For Cisco Nexus 9332D-GX2B switch installation and configuration part of a new AFX A1K or AFX A2K system or maintenance of existing switches, you can reference the applicable Cisco switch documentation and NetApp systems documentation.

NOTE: For step-by-step instructions to install and configure your switches as part of a new AFX A1K or AFX A2K system, see the link:install-configure-switches-in-afx-workflow-9332d.html[Install and configure switches in an AFX system workflow].

== Cisco switch documentation
To install and configure your Cisco Nexus 9332D-GX2B switches as part of a new AFX A1K or AFX A2K system, you can reference the following Cisco documents so you are familiar with the switch release notes, safety information, installation options, initial software configuration, and command references.
