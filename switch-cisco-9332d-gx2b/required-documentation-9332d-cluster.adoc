...
[.lead]
For Cisco Nexus 9332D-GX2B switch installation, be sure to review specific switch and controller documentation to set up your 9332D-GX2B switches and ONTAP cluster.

== Switch documentation
To set up the Cisco Nexus 9332D-GX2B switches, you need the following documentation from link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html[Cisco Nexus 9000 Series Switches Support^]. 
