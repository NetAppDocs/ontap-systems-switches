...
summary: For Cisco Nexus 9332D-GX2B switch installation and setup part of a new AFX A1K or AFX A2K system or maintenance of existing switches, you can reference the applicable Cisco switch documentation and ONTAP systems documentation.
---
...
[.lead]
For Cisco Nexus 9332D-GX2B switch installation and setup part of a new AFX A1K or AFX A2K system or maintenance of existing switches, you can reference the applicable Cisco switch documentation and ONTAP systems documentation.

NOTE: For step-by-step instructions on installing and configuring your switches as part of a new AFX A1K or AFX A2K system installation and setup, see the link:install-configure-switches-in-afx-workflow-9332d.html[Install and configure switches in an AFX system workflow].

== Cisco switch documentation
To install and set up your Cisco Nexus 9332D-GX2B switches as part of a new AFX A1K or AFX A2K system, you can reference the following Cisco install and setup documents so you are familiar with the switch release notes, safety information, installation options, initial software configuration, and command references.

After you install and set up your switches, you can reference the applicable Cisco documents to maintain your switches.
...
To install and set up your Cisco Nexus 9332D-GX2B switches as part of a new AFX A1K or AFX A2K system, you can reference the following documentation and resources.
