...
[.lead]
For Cisco Nexus 9332D-GX2B switch installation and setup part of a new AFX system or maintenance of existing switches, you can reference the applicable Cisco switch documentation and ONTAP systems documentation.

NOTE: For step-by-step instructions on installing and setting up your switches as part of a new AFX system installation and setup, see the link:configure-switch-overview-9332d-cluster.html[Install switches workflow].

== Cisco switch documentation
To install and set up your Cisco Nexus 9332D-GX2B switches as part of a new AFX system, you can reference the following Cisco install and setup documents so you are familiar with the switch release notes, safety information, installation options, initial software configuration, and command references.
...
To install and set up your Cisco Nexus 9332D-GX2B switches as part of a new AFX system, you can reference the following documentation and resources.
