...
[.lead]
For Cisco Nexus 9332D-GX2B switch installation and configuration part of a new AFX A1K or AFX A2K system or maintenance of existing switches, you can reference the applicable Cisco switch documentation and ONTAP systems documentation.
