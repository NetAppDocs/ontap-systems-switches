...
[.lead]
For Cisco Nexus 9332D-GX2B switch installation and setup part of a new AFX storage system or maintenance of existing switches, review the applicable Cisco switch documentation and ONTAP systems documentation.

== Cisco switch documentation
To install and set up the Cisco Nexus 9332D-GX2B switches as part of a new AFX storage system, you need to review the following Cisco install and setup documents so you are familiar with the switch release notes, safety information, installation options, initial software configuration, and command references.

After you install and setup your switches, you can reference the applicable Cisco documents to maintain your switches.
...
NOTE: You can reference this documentation when you install and setup your new AFX storage system and switches; however, for step-by-step instructions, start with the link:configure-switch-overview-9332d-cluster.html[Installation and setup workflow for Cisco Nexus 9332D-GX2B switches^].
