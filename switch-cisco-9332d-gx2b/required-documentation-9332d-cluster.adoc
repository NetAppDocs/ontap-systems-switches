...
NOTE: For step-by-step instructions on installing and setting up your switches as part of a new AFX A1K or AFX A2K system installation and setup, see the link:configure-switch-overview-9332d-cluster.html[Install switches workflow].
