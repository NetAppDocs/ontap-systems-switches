...
After you've reviewed the install or upgrade RCF overview, you link:configure-install-rcf-9332d.html[install the RCF] or link:upgrade-rcf-software-9332d-cluster.html[upgrade the RCF] as needed.
