...
summary: "Upgrade the RCF on Cisco Nexus 9332D-GX2B switches to support new hardware, a new ONTAP version, or a new NX-OS version on AFX 1K or AFX 2K systems."
---
= Upgrade the RCF on the Cisco Nexus 9332D-GX2B switch
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the reference configuration file (RCF) on Cisco Nexus 9332D-GX2B switches to support new hardware, a new ONTAP version, or a new NX-OS version on AFX 1K or AFX 2K systems.
