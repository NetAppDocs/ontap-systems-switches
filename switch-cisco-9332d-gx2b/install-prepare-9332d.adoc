...
|===
+
* RCF 10.1 has different files for different use cases. Depending on how you plan to use the switches in your AFX system configuration (shared, storage only, or cluster and HA only), you choose the applicable RCF file.
+
