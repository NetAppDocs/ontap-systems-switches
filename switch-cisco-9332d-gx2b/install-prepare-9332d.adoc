...
summary: "Prepare to install Cisco Nexus 9332D-GX2B switches as part of a new AFX 1K or AFX 2K system by reviewing switch documentation, supported RCF versions, and Smart Call Home requirements."
---
= Prepare to install Cisco Nexus 9332D-GX2B switches in an AFX system
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Prepare to install Cisco Nexus 9332D-GX2B switches as part of a new AFX 1K or AFX 2K system by reviewing the applicable Cisco switch documentation, understanding supported RCF versions, and considering Smart Call Home configuration.
