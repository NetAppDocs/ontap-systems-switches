...
+
For example, if you are using your switches as shared switches, you use RCF file `RCF-v10.1-NX9332D-GX2B-CL1-ST1-100GBR15-400G15.txt`. The following table shows the preset groups of the switch ports, their port speeds, and usage for this RCF file.
+
[options="header" cols="1,2"]
|===
| Switch port groups | Port speeds and usage
