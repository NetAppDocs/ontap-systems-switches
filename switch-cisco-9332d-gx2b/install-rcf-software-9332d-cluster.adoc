...
[.lead]
You install the RCF after setting up the Nexus 9332D-GX2B switch for the first time. (Or, You install the RCF as part of the switch setup...as part of a new sys install, switch replacement or reset?)
