...
summary: After you complete the switch configuration procedures, you need to power on the storage shelves and controllers in your AFX 1K or AFX 2K system, complete the system setup, and then verify the switch connectivity.
---
...
[.lead]
After you complete the switch configuration procedures, you need to power on the storage shelves and controllers in your AFX 1K or AFX 2K system, complete the system setup, and then verify the switch connectivity.
...
Lisa: It doesn't make sense for these 3 steps (below) at this point in time because the AFX controllers are not powered on yet. Andris suggested moving them to the AFX power on system/controllers topic after step 4 (secure power cords). However, step 2 doesn't make sense after powering on the AFX system because VLANs have not been created yet (they are created in AFX Complete cluster setup topic). Maybe we slip these steps up. Asking Andris. FYI: moving these 3 steps (there are versions for 9332 and 9364) to AFX topics reduces the back and forth between the switch repo and AFX repo.
...
After you've completed the AFX 1K or AFX 2K system setup and verified the switch connectivity, you are ready to use your AFX system.
