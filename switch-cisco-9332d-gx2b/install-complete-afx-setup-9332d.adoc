...
Lisa: It doesn't make sense for these 3 steps (below) at this point in time because the AFX controllers are not powered on yet. Andris suggested moving them to the AFX power on system/controllers topic after step 4 (secure power cords). However, step 2 doesn;t make sense after powering on the AFX system becasue VLANs have not been created yet (they are created in AFX Complete cluster setup topic). Maybe we slip these steps up.Asking Andris.
