...
summary: You install the NX-OS as part of a new AFX system installation, a switch replacement, or a switch reset to factory default settings.
---
...
[.lead]
You install the NX-OS as part of a new AFX system installation, a switch replacement, or a switch reset to factory default settings.
