...
summary: "Install NX-OS on Cisco Nexus 9332D-GX2B switches for new AFX 1K or AFX 2K system installations, switch replacements, or factory default resets."
---
= Install NX-OS on the Cisco Nexus 9332D-GX2B switch
:icons: font
:imagesdir: ../media/

[.lead]
Install NX-OS on Cisco Nexus 9332D-GX2B switches for new AFX 1K or AFX 2K system installations, switch replacements, or when resetting a switch to factory default settings.
...
* Upgrade to 10.4(5)(M) - KILL
* Upgrade from 10.4(5)(M) or earlier to 10.5(3)(F) or later - ReWORK
* Upgrade from 10.5(3)(F) to a later version - REUSE 9808 steps
...
.Upgrade from 10.4(2)(F) to 10.6(3)(F) or later
//Correct tab tite
--
[start=a]
...
--
.Upgrade from 10.6(3)(F) to a later version
// REWRK using 9808 steps!!!!!!!!!!!!!!!
--
...
//below are the old steps. Verify against 9808 above and then delet below.
.. Copy the NX-OS and EPLD image to the first switch.
+
`copy <protocol>: bootflash: vrf management`
+
...
What I had, but now part of one of the tabs...?
...
// AFFFASDOC-497, 2026-Aug (EPLD issue for 9336 affects 9332 and 9364 also)