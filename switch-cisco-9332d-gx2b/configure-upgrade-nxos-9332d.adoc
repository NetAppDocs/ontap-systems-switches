...
Using the ONTAP CLI, complete the NX-OS upgrade by verifying the connectivity of the remote cluster interfaces, re-enabling auto-revert on the cluster LIFs, and verifying the cluster LIFs reverted to their home ports.
