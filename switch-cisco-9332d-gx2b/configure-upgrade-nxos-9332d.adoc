...
//This tab's steps below are modified from 9336 Upgrade NX-OS.
...
....
cs2# *copy sftp: bootflash: vrf management*
Enter source filename: */code/nxos64-cs.10.6.3.F.bin*
Enter hostname for the sftp server: *172.19.2.1*
Enter username: *user1*
...
sftp> *progress*
Progress meter enabled
sftp> *get /code/nxos64-cs.10.6.3.F.bin /bootflash/nxos64-cs.10.6.3.F.bin*
/code/nxos64-cs.10.6.3.F.bin  100% 1261MB   9.3MB/s   02:15
sftp> *exit*
Copy complete, now saving to disk (please wait)...
Copy complete.
....
...
....
cs2# *install all nxos bootflash:/nxos64-cs.10.6.3.F.bin*
...
Software
  ...
  NXOS image file is: bootflash:///nxos64-cs.10.6.3.F.bin
...
EPLD Install Image: EPLD image file 10.6.3.F. built on Fri Dec 12 11:15:18 2026
...
EPLD Install Image: EPLD image file 10.6.3.F. built on Fri Dec 12 11:15:18 2025
...
. Old (original) steps below. I think steps 1-6 below get replaced by the tabbed step above. But rest of steps (below) after that for to verify ONTAP stuff, so should stay. But check against 9336 Upgrade NX-OS steps to make sure.
