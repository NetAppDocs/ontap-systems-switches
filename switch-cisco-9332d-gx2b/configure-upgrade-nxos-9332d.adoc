...
Prepare to install the NX-OS by making sure you have a management network connection, downloading the NX-OS version, checking port status on the cluster, and disabling auto-revert on the cluster LIFs. 
