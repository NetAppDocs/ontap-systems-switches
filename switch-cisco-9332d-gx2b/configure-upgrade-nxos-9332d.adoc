...
+
The following step shows an upgrade from NX-OS 10.4(2)(F) to 10.6(3)(F). The first pass performs the NX-OS upgrade and the second pass performs the EPLD image upgrade.
+
...
....
cs1# *install all nxos bootflash:/nxos64-cs.10.6.3.F.bin*
