---
permalink: switch-cisco-9332d-gx2b/fyi-verify-the-switch-connections-3-steps-moved-to-afx-power-on-9332d.html
sidebar: sidebar
...
---
= FYI - verify switch connections see step 3 section - Cisco Nexus 9332D-GX2B
:icons: font
:imagesdir: ../media/
