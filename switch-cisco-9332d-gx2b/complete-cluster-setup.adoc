...
[.lead]
After you complete the switch setup procedures (on your powered on switches), you need to power on the storage shelves and controllers in your AFX system, complete the AFX system setup, and then verify the switch connectivity.

.Before you begin
* You must have completed all of the link:install-prepare-9332d-cluster.html[setup switch workflow] procedures. That includes:
...
After you've completed the AFX system setup, and verified the switch connectivity, you are ready to use your AFX system.
