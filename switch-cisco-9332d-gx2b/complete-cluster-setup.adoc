...
* For an AFX 2K system, go to the link:https://review.docs.netapp.com/us-en/ontap-afx_working-afx-emr-dr/install-afx-2k/power-on-hardware.html[Power on your AFX 2K storage system^] procedure.
