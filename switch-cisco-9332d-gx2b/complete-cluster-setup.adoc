...
summary: After you complete the switch setup procedures, you need to power on the storage shelves and controllers in your AFX system, complete the AFX system setup, and then verify the switch connectivity.
---
...
[.lead]
After you complete the switch setup procedures, you need to power on the storage shelves and controllers in your AFX system, complete the AFX system setup, and then verify the switch connectivity.
