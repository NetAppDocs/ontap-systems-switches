...
.Before you begin
* You must have completed the switch setup procedures in the link:install-prepare-9332d-cluster.html[Setup switch workflow]. 
...
.. For an AFX A2K system, go to the link:https://docs.netapp.com/us-en/ontap-afx/install-setup/power-on-hardware.html[Power on your AFX 2K storage system^] procedure. NEED to confirm the link!!!!
...
After you've completed the AFX A1K or AFX A2K system setup, and verified the switch connectivity, you are ready to use your AFX A1K or AFX A2K system.
