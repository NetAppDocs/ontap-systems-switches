...
summary: After you complete the switch configuration procedures, you need to power on the storage shelves and controllers in your AFX A1K or AFX A2K system, complete the system setup, and then verify the switch connectivity.
---
...
[.lead]
After you complete the switch configuration procedures, you need to power on the storage shelves and controllers in your AFX A1K or AFX A2K system, complete the system setup, and then verify the switch connectivity.
...
* For an AFX A2K system, go to the link:https://docs.netapp.com/us-en/ontap-afx/install-afx-2k/power-on-hardware.html[Power on your AFX 2K storage system^] procedure. 
+
