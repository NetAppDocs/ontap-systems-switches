...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four]link:install-upgrade-rcf-overview-cluster-9332d.html[Install or upgrade the RCF] 
[role="quick-margin-para"]
