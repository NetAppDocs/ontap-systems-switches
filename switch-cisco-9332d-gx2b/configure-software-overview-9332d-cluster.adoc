...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five]link:configure-ssh-keys.html[Configure SSH on the Cisco 9332D-GX2B switches] 
[role="quick-margin-para"]
Configure SSH on the Cisco 9364D-GX2A switch to use the Ethernet Switch Health Monitor (CSHM) and log collection features.
