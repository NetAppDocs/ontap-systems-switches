...
[.lead]
After you completed cabling and powering on your switch(es) as part of a new system installation and setup or switch replacement, you need to verify the switch connections.
...
After you've verified each switch is connected properly, you link:install-nxos-overview-9332d-cluster.html[prepare to install the NX-OS] on the switch(es).
