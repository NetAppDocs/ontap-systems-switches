...
summary: You can install or upgrade the NX-OS on your Nexus 9332D-GX2B switches depending on the available supported NX-OS versions for the switches in your AFX 1K or AFX 2K system. You install a supported version of NX-OS on the switches as part of a new AFX system installation, a switch replacement, or a switch reset to factory default settings. You upgrade to a supported version of NX-OS on the switches to support new hardware or a new ONTAP version in your AFX system.
---
