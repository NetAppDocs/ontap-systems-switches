...
After you've installed NX-OS on your switches, you install RCF starting with the link:link:configure-install-upgrade-rcf-overview-9332d.html[Install or upgrade the RCF overview].
