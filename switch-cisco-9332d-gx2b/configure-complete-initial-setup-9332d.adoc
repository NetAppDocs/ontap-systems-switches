...
* If needed, you can look at the information for setting up the switches in the "Using the Cisco NX-OS Setup Utility" chapter of the link:reference-documentation-9332d.html[Cisco Nexus 9000 Series NX-OS Fundamentals Configuration Guide, Release 10.6(x)]. 
