---
permalink: switch-cisco-9332d-gx2b/configure-complete-initial-setup-switch-9332d.html
sidebar: sidebar
...
After you've completed the initial switch setup, you link:configure-prepare-install-nxos-rcf-9332d.html[prepare to install the NX-OS and RCF].
