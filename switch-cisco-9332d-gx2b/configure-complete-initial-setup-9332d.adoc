...
//* Make sure you have the following network and configuration information for each switch to complete the initial switch setup:
...
//* Make sure you have the applicable licenses.


.About this task
* You must complete the initial setup on each switch.

* If needed, you can refer to the information for setting up the switches in the "Using the Cisco NX-OS Setup Utility" chapter of the link:reference-documentation-9332d.html[Cisco Nexus 9000 Series NX-OS Fundamentals Configuration Guide, Release 10.6(x)]. 
...
After you've completed the initial switch setup, you link:configure-install-nxos-9332d.html[install the NX-OS].

Or you link:configure-review-cabling-config-requirements-9332d.html[review the cabling and configuration requirements].
// If we keep the above topic in tact, then that's where users go next. If we deivide up the topic, then they go to install nxos.
