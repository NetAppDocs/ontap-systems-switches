...
After you've installed or upgraded the NX-OS software, you link:install-upgrade-rcf-overview-cluster-9332d.html[install or upgrade the Reference Configuration File (RCF)].
