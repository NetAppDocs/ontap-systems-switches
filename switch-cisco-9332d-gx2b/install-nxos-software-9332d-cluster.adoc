...
cs2(FLM284504N6)             cluster-network   10.228.137.253   N9K-C9332D-GX2B
...
. Copy the NX-OS software to the Nexus 9332D-GX2B switch.
+
.Show example
[%collapsible]
====
...
. Install the NX-OS software on the Nexus 9332D-GX2B switch.
+
.Show example
[%collapsible]
====
