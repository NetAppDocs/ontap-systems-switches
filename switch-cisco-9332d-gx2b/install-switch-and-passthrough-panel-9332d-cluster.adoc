---
permalink: switch-cisco-9332d-gx2b/install-switch-and-passthrough-panel-9332d-cluster.html
sidebar: sidebar
keywords: install, cisco, nexus, switch, pass-through, panel, netapp, cabinet, bracket, switch, install a cisco nexus 9332d-gx2b switch and pass-through panel in a netapp cabinet - cisco nexus 9332d-gx2b
summary: You can install the Cisco Nexus 9332D-GX2B switch and pass-through panel in a NetApp cabinet with the standard brackets that are included with the switch.
---
= Install a Cisco Nexus 9332D-GX2B switch in a NetApp cabinet
:icons: font
:imagesdir: ../media/
...
. Install the rack-mount brackets on the Nexus 9332D-GX2B switch chassis.
...
+
The two 9332D-GX2B switches are always mounted in the top 2U of the cabinet RU41 and 42.
...
. Connect the management port on each 9332D-GX2B switch to either of the management switches (if ordered) or connect them directly to your management network.
+
...
.What's next?
link:setup-switch-9332d-cluster.html[Configure the Cisco Nexus 9332D-GX2B switch]. 
