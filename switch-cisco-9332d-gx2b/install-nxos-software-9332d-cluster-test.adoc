...
summary: You can install or upgrade the NX-OS on your Nexus 9332D-GX2B switches depending on the available supported NX-OS versions for the switches in your AFX 1K or AFX 2K system.
---
...
[.lead]
You can install or upgrade the NX-OS on your Nexus 9332D-GX2B switches depending on the available supported NX-OS versions for the switches in your AFX 1K or AFX 2K system.

You install a supported version of NX-OS on the switches as part of a new AFX 1K or AFX 2K system installation, a switch replacement, or a reset to factory default settings.

You upgrade to a supported version of NX-OS on the switches to support new hardware or a new ONTAP version in your AFX 1K or AFX 2K system.
...
** For switches in an AFX 1K system, running any supported version of ONTAP, NX-OS 10.4.2 is the only supported version.

** For switches in an AFX 2K system, running ONTAP 9.19.1GA or later, NX-OS 10.6 is the only supported version at the initial release of ONTAP 9.19.1GA.
