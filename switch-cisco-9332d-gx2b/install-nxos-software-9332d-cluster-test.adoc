...
[.lead]
You install NX-OS on the Cisco 9332D-GX2B switches as part of a new AFX A1K or AFX A2K system installation, a switch replacement, or a reset to factory default settings. 
