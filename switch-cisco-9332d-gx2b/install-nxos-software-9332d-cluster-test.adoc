...
summary: You install the NX-OS on the Cisco 9332D-GX2B switches as part of a new AFX system installation, a switch replacement, or a reset to factory default settings.
---
...
[.lead]
You install NX-OS on the Cisco 9332D-GX2B switches as part of a new AFX system installation, a switch replacement, or a reset to factory default settings. 
...
** For switches in an AFX A1K system, NX-OS 10.4.2 is the only supported version.

** For switches in an AFX A2K system, NX-OS 10.6 is the only supported version at initial release.
+
...
== Step 1: Review suggested documentation

Consult the switch compatibility table for the supported ONTAP and NX-OS versions. 

(But if only 10.4.2 is supported, why am I shopping for an NX-OS version? And would this section really be "Verify version you need". And then is such a section needed at all?)

link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet switch page^] 

//include::../_include/cisco-nxos-install-suggested-documents.adoc[]
 

== Step 2: Prepare to install the NX-OS
...
== Step 4: Complete the NX-OS installation
