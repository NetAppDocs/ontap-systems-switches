---
permalink: switch-cisco-9332d-gx2b/install-nxos-software-9332d-cluster-test.html
sidebar: sidebar
keywords: procedure, install, nx-os, software, nexus, cluster, switch, install the nx-os software - cisco nexus 9332d-gc2b
summary: You can install or upgrade the NX-OS on your Nexus 9332D-GX2B switches depending on the available supported NX-OS versions for the switches in your AFX A1K or AFX A2K system.
---
...
[.lead]
You can install or upgrade the NX-OS on your Nexus 9332D-GX2B switches depending on the available supported NX-OS versions for the switches in your AFX A1K or AFX A2K system.

You install a supported version of NX-OS on the switches as part of a new AFX A1K or AFX A2K system installation, a switch replacement, or a reset to factory default settings.

You upgrade to a supported version of NX-OS on the switches to support new hardware or a new ONTAP version in your AFX A1K or AFX A2K system.
...
* You must have completed the link:install-nxos-overview-9332d-cluster.html[Prepare to install the NX-OS and RCF] procedure.
...
* The type of AFX system your switches are in determines the supported versions of NX-OS for your switches.

** For switches in an AFX A1K system, running any supported version of ONTAP, NX-OS 10.4.2 is the only supported version.

** For switches in an AFX A2K system, running ONTAP 9.19.1GA or later, NX-OS 10.6 is the only supported version at the initial release of ONTAP 9.19.1GA.
+
...
* NX-OS installation or upgrade is independent of RCF installation or upgrade. However, if you are installing or upgrading both the NX-OS and RCF, it is recommended to install or upgrade the NX-OS first, then the RCF. 
...
* The procedure requires the use of ONTAP commands and Cisco Nexus 9000 Series Switches commands; ONTAP commands are used unless otherwise indicated.
...
After you've installed NX-OS on your switches, you install RCF starting with the link:install-upgrade-rcf-overview-cluster.html[Install or upgrade the RCF overview].
