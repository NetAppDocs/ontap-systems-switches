...
---
= Install or upgrade NX-OS - Cisco Nexus 9332D-GX2B
:icons: font
:imagesdir: ../media/
...
NOTE: NX-OS installation or upgrade is independent of RCF installation or upgrade. If you are installing or upgrading both the NX-OS and RCF, it is recommended to install or upgrade the NX-OS first.
