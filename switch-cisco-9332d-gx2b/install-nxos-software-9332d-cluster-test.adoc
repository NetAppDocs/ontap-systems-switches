...
---
= Install the NX-OS software - Cisco Nexus 9332D-GX2B
:icons: font
:imagesdir: ../media/

[.lead]
You install the NX-OS on the Cisco 9332D-GX2B switches as part of a new AFX system installation, a switch replacement, or a reset to factory default settings. 
...
// This bullet only applies to the upgrade NX-OS version of this topic. Do not upgrade or downgrade your NX-OS version to an unsupported version; only 10.4.2 is currently supported.
...
Hey, Lisa, I think a lot of the prepare stuff here is the same stuff in the Prepare to install NX-OS and RCF topic. Do a line-by-line comparison.
...
== Step 3: Install the NX-OS

You install the NX-OS on one of the switches and then you repeat these steps to install NX-OS on the second switch.
