...
summary: "Install a Cisco Nexus 3232C cluster switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch."
---
...
[.lead]
Install a Cisco Nexus 3232C cluster switch and pass-through panel in a NetApp cabinet using the standard brackets included with the switch.
