...
summary: "Review the migration requirements before replacing CN1610 cluster switches with Cisco Nexus 3232C cluster switches."
---
= Review migration requirements for Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the configuration information, port connections, and cabling requirements before replacing CN1610 cluster switches with Cisco Nexus 3232C cluster switches.
...
* The link:https://hwu.netapp.com/[Hardware Universe^] contains information about supported cabling to Nexus 3232C switches:
