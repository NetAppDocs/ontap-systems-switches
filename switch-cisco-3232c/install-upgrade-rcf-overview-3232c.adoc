...
summary: "Install or upgrade the RCF on Cisco Nexus 3232C cluster switches after initial setup or when a newer version is available."
---
= Learn about installing or upgrading the RCF on Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/
...
The following table lists the available RCFs for 3232C switches. Choose the applicable RCF version for your configuration. Refer to  link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] for more information.
...
For details of the available RCF configurations, refer to  link:configure-software-overview-3232c-cluster.html[Software install workflow].
...
After you've reviewed the install RCF or upgrade RCF procedure overview, you can link:install-rcf-software-3232c.html[install the RCF] or link:upgrade-rcf-software-3232c.html[upgrade your RCF] as required.
