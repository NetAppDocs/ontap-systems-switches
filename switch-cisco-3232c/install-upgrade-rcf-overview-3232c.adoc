...
After you've reviewed the install RCF or upgrade RCF procedure, you can link:install-rcf-software-3232c.html[install the RCF] or link:upgrade-rcf-software-3232c.html[upgrade your RCF] as required.
