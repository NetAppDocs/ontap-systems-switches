...
summary: "Complete the migration from a two-node switchless cluster to Cisco Nexus 3232C cluster switches."
---
= Complete the migration from a two-node switchless cluster to Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Complete the final steps to migrate from a two-node switchless cluster to a two-node switched cluster using Cisco Nexus 3232C cluster switches.
...
.What's next?
After you've completed your switch migration, you can link:../switch-cshm/config-overview.html[configure switch health monitoring].
