...
summary: "Review the configuration requirements for Cisco Nexus 3232C cluster switches before installation or upgrade."
---
= Review configuration requirements for Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the configuration requirements for Cisco Nexus 3232C cluster switches before installation or upgrade. 
...
After you've confirmed your configuration requirements, you can review the link:required-documentation-3232c.html[required documentation].
