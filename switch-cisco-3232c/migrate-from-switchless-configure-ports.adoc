...
summary: "Configure ports for migration from a two-node switchless cluster to Cisco Nexus 3232C cluster switches."
---
= Configure ports for migration from a two-node switchless cluster to Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Configure ports for migration from a two-node switchless cluster to a two-node switched cluster using Cisco Nexus 3232C cluster switches.
...
.What's next?
After you've configured your ports, you can link:migrate-from-switchless-complete-migration.html[complete your migration].    
