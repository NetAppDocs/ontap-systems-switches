...
summary: "Review the documentation required to install and maintain Cisco Nexus 3232C cluster switches."
---
= Review documentation requirements for Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Review the switch and controller documentation required to set up Cisco Nexus 3232C cluster switches and configure them in an ONTAP cluster. 
...
To install a 3232C Cisco switch in a NetApp cabinet, refer to the following hardware documentation.
