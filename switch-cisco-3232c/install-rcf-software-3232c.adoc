...
summary: "Install the reference configuration file (RCF) on Cisco Nexus 3232C cluster switches after initial setup."
---
= Install the RCF on Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the reference configuration file (RCF) on Cisco Nexus 3232C cluster switches after initial setup. The RCF defines port assignments and network settings required for cluster operation.
