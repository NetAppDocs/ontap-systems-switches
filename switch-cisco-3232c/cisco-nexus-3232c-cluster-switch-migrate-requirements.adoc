---
permalink: switch-cisco-3232c/cisco-nexus-3232c-cluster-switch-migrate-requirements.html
sidebar: sidebar
...
[.lead]
You must be aware of certain configuration information, port connections, and cabling requirements when you migrate to Cisco Nexus 3232C cluster switches.
