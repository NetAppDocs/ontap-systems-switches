...
summary: "Prepare to migrate from a two-node switchless cluster to Cisco Nexus 3232C cluster switches."
---
= Prepare to migrate from a switchless cluster to Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Prepare your two-node switchless cluster for migration to a switched cluster using Cisco Nexus 3232C cluster switches.
...
+
For more information on Cisco commands, refer to the following list in the link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-command-reference-list.html[Cisco Nexus 3000 Series NX-OS Command References^].
+
.Show example
[%collapsible]
====
...
.What's next?
After you've prepared to migrate your switches, you can link:migrate-from-switchless-configure-ports.html[configure your ports].
