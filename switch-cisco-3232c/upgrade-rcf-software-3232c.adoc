...
summary: "Upgrade the reference configuration file (RCF) on Cisco Nexus 3232C cluster switches when a newer version is available."
---
= Upgrade the RCF on Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the reference configuration file (RCF) on Cisco Nexus 3232C cluster switches when a newer version of the RCF is available. 
