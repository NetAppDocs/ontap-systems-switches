...
summary: "Follow this workflow to install and configure Cisco Nexus 3232C cluster switches in an ONTAP environment."
---
= Installation and setup workflow for Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure Cisco Nexus 3232C cluster switches in an ONTAP environment. The 3232C supports ONTAP clusters with more than two nodes. 
