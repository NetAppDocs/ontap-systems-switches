...
summary: "Migrate from Cisco Nexus 5596 cluster switches to Cisco Nexus 3232C cluster switches without disrupting cluster operation."
---
= Migrate from Cisco Nexus 5596 cluster switches to Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate existing Cisco Nexus 5596 cluster switches to Cisco Nexus 3232C cluster switches without disrupting cluster operation.
...
* The other two nodes use two 40 GbE cluster interconnect ports: e4a, e4e. The link:https://hwu.netapp.com/[Hardware Universe^] lists the actual cluster ports on your platforms.
...
+
Refer to the __ONTAP 8.x or later Cluster and Management Network Switch Reference Configuration Files__ Download page, and then click the appropriate version.
+
To find the correct version, refer to the _ONTAP 8.x or later Cluster Network Switch Download page_.
...
+
For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-command-reference-list.html[Cisco Nexus 3000 Series NX-OS Command References^].
+
.Show example
[%collapsible]
====
