...
summary: "Install Cisco Nexus 3232C cluster switches to prepare them for network operation."
---
= Install Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install Cisco Nexus 3232C cluster switches to prepare them for network operation.
