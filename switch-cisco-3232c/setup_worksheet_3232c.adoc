...
summary: "Complete the cabling worksheet for Cisco Nexus 3232C cluster switches to document port connections and supported platform configurations."
---
= Complete the Cisco Nexus 3232C cabling worksheet
:icons: font
:imagesdir: ../media/

[.lead]
Complete the cabling worksheet for Cisco Nexus 3232C cluster switches to document port connections and supported platform configurations. 
...
After you've completed your cabling worksheets, you can link:install-switch-3232c.html[install the switch].
