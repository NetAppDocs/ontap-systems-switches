...
summary: "Configure the Cisco Nexus 3232C cluster switch using initial setup commands to prepare it for cluster operation."
---
= Configure the Cisco Nexus 3232C cluster switch
:icons: font
:imagesdir: ../media/

[.lead]
Configure the Cisco Nexus 3232C cluster switch using initial setup commands to prepare it for cluster operation.
...
+
Refer to link:required-documentation-3232c.html[Required documentation] for more information.
...
a|
Refer to the _Installing a Cisco Nexus 3232C cluster switch and pass-through panel in a NetApp cabinet_ guide for instructions to install the switch in a NetApp cabinet.
a|
...
After you've configured your switches, you can link:prepare-install-cisco-nexus-3232c.html[prepare to install the NX-OS and RCF].
