...
summary: "Follow this workflow to install the hardware for Cisco Nexus 3232C cluster switches."
---
= Hardware installation workflow for Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Follow this workflow to install and configure the hardware for Cisco Nexus 3232C cluster switches.
