...
summary: "Migrate from NetApp CN1610 cluster switches to Cisco Nexus 3232C cluster switches without disrupting cluster operation."
---
= Migrate from NetApp CN1610 cluster switches to Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate existing NetApp CN1610 cluster switches to Cisco Nexus 3232C cluster switches without disrupting cluster operation.
...
The examples in this procedure use four nodes: Two nodes use four 10 GbE cluster interconnect ports: e0a, e0b, e0c, and e0d. The other two nodes use two 40 GbE cluster interconnect fiber cables: e4a and e4e. Refer to the link:https://hwu.netapp.com/[Hardware Universe^] for information about the cluster fiber cables on your platforms. Refer to the Knowledge Base article link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU[What additional information do I need to install my equipment that is not in HWU?^] for more information about switch installation requirements.
...
.. Refer to link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch[Cisco Ethernet Switches^] on the NetApp Support Site.
...
.. Download the appropriate version of the image software at link:https://mysupport.netapp.com/site/products/all/details/cisco-cluster-storage-switch/downloads-tab[Cisco® Cluster and Management Network Switch Reference Configuration File Download^].
...
+
For more information on Cisco commands, refer to the guides listed in the link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-command-reference-list.html[Cisco Nexus 3000 Series NX-OS Command References^].
+
.Show example
[%collapsible]
====
