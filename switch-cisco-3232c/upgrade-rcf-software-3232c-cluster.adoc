---
permalink: switch-cisco-3232c/upgrade-rcf-software-3232c-cluster.html
sidebar: sidebar
...
cluster1-01/cdp
            ...
            e0b    cs2                       Ethernet1/7       N3K-C3232C
cluster1-02/cdp
            e0a    cs1                       Ethernet1/8       N3K-C3232C
            e0b    cs2                       Ethernet1/8       N3K-C3232C
cluster1-03/cdp
...
----
cs1# *config*
cs1(config)# *interface eth1/1/1-2,eth1/1/7-8*
