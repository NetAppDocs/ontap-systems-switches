...
summary: "Install the NX-OS software on Cisco Nexus 3232C cluster switches to prepare them for cluster operation."
---
= Install NX-OS software on Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Install the NX-OS software on Cisco Nexus 3232C cluster switches to prepare them for cluster operation.
...
+
Refer to link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html[EPLD Upgrade Release Notes, Release 9.3(11)^] for further details. 
+
.Show example
[%collapsible]
====
...
After you've installed the NX-OS software, you can link:install-upgrade-rcf-overview-3232c.html[install or upgrade the Reference Configuration File (RCF)].
