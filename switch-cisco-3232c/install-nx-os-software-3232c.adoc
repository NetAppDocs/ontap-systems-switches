...
. If you are upgrading to NX-OS version 9.3.11, then after the switch reboot, log in again, upgrade the EPLD golden image and reboot the switch once again else skip to step 12. 
+
