...
---
= Overview and requirements: Cisco Nexus 3232C switches
:icons: font
:imagesdir: ../media/

[.lead]
For Cisco Nexus 3232C switch installation and maintenance, be sure to review all requirements and recommended documentation. 

== Task overview

You can use Cisco Nexus 3232C switches as cluster switches in your AFF or FAS cluster. Installation and maintenance tasks include:

* Installing the Cisco Nexus 3232C switch (X190100) in a NetApp system cabinet with the custom brackets that come with the switch, or installing it in a rack with the standard brackets that are also included with the switch.
* Installing NX-OS software and reference configuration files (RCF's) on the Cisco Nexus 3232C cluster switch.
