...
summary: "Migrate from a two-node switchless cluster to a switched cluster using Cisco Nexus 3232C cluster switches. This is a nondisruptive procedure."
---
= Migrate from a two-node switchless cluster to Cisco Nexus 3232C cluster switches
:icons: font
:imagesdir: ../media/

[.lead]
Migrate from a two-node switchless cluster to a switched cluster using Cisco Nexus 3232C cluster switches. This is a nondisruptive procedure.
...
The examples in this procedure use two nodes, each utilizing two 40 GbE cluster interconnect ports e4a and e4e. The link:https://hwu.netapp.com/[Hardware Universe^] has details about the cluster ports on your platforms.
