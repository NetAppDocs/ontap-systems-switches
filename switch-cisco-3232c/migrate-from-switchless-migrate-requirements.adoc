...
summary: "Review the requirements for migrating from a two-node switchless cluster to Cisco Nexus 3232C cluster switches."
---
= Review requirements for migrating from a switchless cluster to Cisco Nexus 3232C cluster switches
:imagesdir: ../media/

[.lead]
Review the requirements for migrating from a two-node switchless cluster to a switched cluster using Cisco Nexus 3232C cluster switches. 
...
.What's next?
After you've reviewed the migration requirements, you can link:migrate-from-switchless-prepare-to-migrate.html[prepare to migrate your switches].
