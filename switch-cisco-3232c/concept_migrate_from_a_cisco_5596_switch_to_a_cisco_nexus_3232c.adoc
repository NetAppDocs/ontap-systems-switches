---
permalink: switch-cisco-3232c/concept_migrate_from_a_cisco_5596_switch_to_a_cisco_nexus_3232c.html
sidebar: sidebar
...
---
= Migrating from a Cisco Nexus 5596 switch to a Cisco Nexus 3232C switch
:icons: font
:imagesdir: ../media/
