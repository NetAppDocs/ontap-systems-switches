---
permalink: switch-cisco-3132qv/task_install_nx_os_software_and_rcfs_on_cisco_nexus_3132q_v_cluster_switches.html
sidebar: sidebar
...
---
= Installing NX-OS software and RCFs on Cisco Nexus 3132Q-V cluster switches
:icons: font
:imagesdir: ../media/
...
. For ONTAP releases 9.5P16, 9.6P12, and 9.7P10 and later patch releases, enable the Ethernet switch health monitor log collection feature for collecting switch-related log files, using the commands: `system cluster-switch log setup-password`
+
