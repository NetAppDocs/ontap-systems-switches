---
permalink: switch-cisco-3132qv/task_install_the_reference_configuration_file_rcf_3132q_v.html
sidebar: sidebar
...
. Verify that the cluster ports have migrated to the ports hosted on cluster switch cs1. This might take a few seconds.`network interface show -role cluster`
+
----
cluster1::*> **network interface show -role cluster**
            Logical           Status     Network            Current       Current Is
