---
permalink: switch-cisco-3132qv/task_install_the_nx_os_software_3132q_v.html
sidebar: sidebar
keywords: installing Cisco cluster switches,installing NX-OS software
summary: 'You can use this procedure to install the NX-OS software on the Nexus 3132Q-V cluster switch.'
---
= Installing the NX-OS software
:icons: font
:imagesdir: ../media/
