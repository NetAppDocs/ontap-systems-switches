---
permalink: switch-cisco-9808/replace-9808-cluster.html
sidebar: sidebar
...
---
= Replace a Cisco Nexus 9808 switch
:icons: font
:imagesdir: ../media/

[.lead]
Follow these steps to replace a defective Nexus 9808 switch in a shared network. This is a nondisruptive procedure (NDU).
...
// Not part of refactor content project phase 1 with 2K/RCF 10.1 content, GH#423 2026-JUN. Ran out of time.