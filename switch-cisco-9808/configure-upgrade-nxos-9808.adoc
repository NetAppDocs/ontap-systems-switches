...
You install the NX-OS on the first switch (cs1) by installing and verifying the new version of the NX-OS and EPLD, verifying the health of all ports on the cluster, and then repeat these steps on the second switch (cs2).
