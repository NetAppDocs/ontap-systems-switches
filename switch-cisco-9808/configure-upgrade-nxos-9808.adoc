...
. Using the switch CLI, verify that the new version of EPLD loaded successfully:
+
...
Port      IPspace      Broadcast Domain Link MTU  Admin/Oper    Status   Status
--------- ------------ ---------------- ---- ---- ------------- -------- ------
e2a       Cluster      Cluster          up   9000  auto/4000000 healthy  false
e2b       Cluster      Cluster          up   9000  auto/4000000 healthy  false
