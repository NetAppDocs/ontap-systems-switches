...
summary: "Upgrade the NX-OS on Cisco Nexus 9808 switches to support new hardware or a new ONTAP version on AFX 2K systems."
---
= Upgrade NX-OS on the Cisco Nexus 9808 switch
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the NX-OS on Cisco Nexus 9808 switches to support new hardware or a new ONTAP version on AFX 2K systems.
