...
summary: You install the NX-OS on your Cisco Nexus 9808 switch(es) as part of a new AFX 1K or AFX 2K system installation, a switch replacement, or a switch reset to factory default settings.
---
...
[.lead]
You install the NX-OS on your Cisco Nexus 9808 switch(es) as part of a new AFX 1K or AFX 2K system installation, a switch replacement, or a switch reset to factory default settings.
...
// New content for Chiffon project, 2026-JUN-08
