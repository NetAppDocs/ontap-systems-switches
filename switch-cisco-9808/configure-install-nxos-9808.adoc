...
[.lead]
You install the NX-OS on your Cisco Nexus 9808 switch(es) as part of a new AFX 2K system installation, a FRU replacement, or a switch reset to factory default settings.
...
** For switches in an AFX 2K system, running ONTAP 9.19.1GA or later, NX-OS 10.6(3) and later is supported.
+
