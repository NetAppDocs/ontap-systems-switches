...
summary: "Install NX-OS on Cisco Nexus 9808 switches for new AFX 2K system installations, supervisor module replacements, or factory default resets."
---
= Install NX-OS on the Cisco Nexus 9808 switch
:icons: font
:imagesdir: ../media/

[.lead]
Install NX-OS on Cisco Nexus 9808 switches for new AFX 2K system installations, supervisor module replacements, or when resetting a switch to factory default settings.
