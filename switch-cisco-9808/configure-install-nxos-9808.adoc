...
* If you are installing the NX-OS on switch(es) as part of a new AFX system installation or supervisor module replacement, verify that the version of NX-OS on your switch(es) is the current NetApp-supported version.
+
