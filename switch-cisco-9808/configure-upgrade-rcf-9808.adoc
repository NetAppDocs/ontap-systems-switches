...
+
If your switches are running RCF 10.1 or later, you can link:configure-install-upgrade-rcf-overview-9808.html#change-port-speed-configuration[change the port speed configuration] if needed.
