...
summary: You upgrade the Reference Configuration File (RCF) version on your Cisco Nexus 9808 switches to support new hardware, a new ONTAP version, or to align with a new NX-OS version in your AFX 2K system configuration.
---
...
. Using the switch CLI, on switch cs1, shut down the ports connected to all the ports of the nodes for each line card.
+
...
Refer to the Knowledge Base article link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_out_of_quorum_when_migrating_cluster_lif_during_switch_OS_upgrade[Node out of quorum when migrating cluster LIF during switch OS upgrade^] for further details. 
...
+
For more information on Cisco commands, refer to the appropriate guide in the link:https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences[Cisco Nexus 9000 Series NX-OS Command Reference^] guides.
+
...
+
This example shows the RCF file `RCF-v10.1-NX9808-CL1-ST1.txt` being installed on switch cs1:
+
...
cs1(FOXXXXXXXXX)           cluster-network    10.228.137.234   N9K-C9332D-GX2B
     Serial Number: FOXXXXXXXXX
      Is Monitored: true
            Reason: None
  Software Version: Cisco Nexus Operating System (NX-OS) Software, Version
...
cs1                  Eth1/3         179    H         AFX-1K          e7a           
cs2                  Eth1/4         123    H         AFX-1K          e7a           
cs1                  Eth1/5         179    H         AFX-1K          e10a          
cs2                  Eth1/6         123    H         AFX-1K          e10a          
cs1                  Eth1/7         179    H         AFX-1K          e11a          
cs2                  Eth1/8         123    H         AFX-1K          e11a          
cs1                  Eth1/12        179    H         AFX-1K          e7b           
cs2                  Eth1/13        123    H         AFX-1K          e7b           
cs1                  Eth1/14        179    H         AFX-1K          e10b          
cs2                  Eth1/15        123    H         AFX-1K          e10b          
cs1                  Eth1/16        179    H         AFX-1K          e11b          
cs2                  Eth1/17        123    H         AFX-1K          e11b 
...
After you've upgraded the RCF on your switches, you link:configure-verify-ssh-9808.html[verify SSH for log collection].
