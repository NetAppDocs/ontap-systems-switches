...
summary: "Install or upgrade the RCF on Cisco Nexus 9808 switches for AFX 2K system installations, supervisor module replacements, or to support new hardware or ONTAP versions."
---
= Learn about installing or upgrading the RCF on the Cisco Nexus 9808 switch
:icons: font
:imagesdir: ../media/

[.lead]
Install or upgrade the reference configuration file (RCF) on Cisco Nexus 9808 switches. Install a new RCF for AFX 2K system installations or supervisor module replacements, or upgrade an existing RCF to support new hardware or ONTAP versions.
