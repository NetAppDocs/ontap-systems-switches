...
summary: "Complete the initial setup of Cisco Nexus 9808 switches using the configuration wizard for new AFX 2K system installations, supervisor module replacements, or factory default resets."
---
= Complete the initial setup on the Cisco Nexus 9808 switch
:icons: font
:imagesdir: ../media/

[.lead]
Complete the initial setup of Cisco Nexus 9808 switches using the configuration wizard. This procedure applies to new AFX 2K system installations, supervisor module replacements, and switches reset to factory default settings.
...
* If needed, you can refer to your NX-OS version of the link:https://www.cisco.com/c/en/us/td/docs/dcn/nx-os/nexus9000/106x/configuration/fundamentals/cisco-nexus-9000-series-nx-os-fundamentals-configuration-guide-release-106x.html[Cisco Nexus 9000 Series NX-OS Fundamentals Configuration Guide^] for information about setting up the switches, found in the "Using the Cisco NX-OS Setup Utility" chapter. You can also find information about terminal settings in the "Configuring Terminal Settings and Sessions" chapter.
...
NOTE: SSH is recommended when using the Ethernet Switch Health Monitor (CSHM) for its log collection features. SSHv2 is also recommended for enhanced security.
a|
