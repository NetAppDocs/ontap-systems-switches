...
* link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/products-release-notes-list.html[Cisco Nexus 9000 Series NX-OS Release Notes^] (choose the release notes for the NX-OS release installed on your switches)
...
More information about Smart Call Home can be found in the link:configure-smart-call-9808.html[Configure Smart Call Home] documentation. 

.What's next?

After you've prepared to install your switches, you link:install-switches-9808.html[install the switches].
