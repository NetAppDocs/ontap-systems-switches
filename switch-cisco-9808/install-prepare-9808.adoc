...
summary: "Prepare to install Cisco Nexus 9808 switches as part of a new AFX 2K system by reviewing switch documentation, supported RCF versions, and Smart Call Home requirements."
---
= Prepare to install Cisco Nexus 9808 switches in an AFX system
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Prepare to install Cisco Nexus 9808 switches as part of a new AFX 2K system by reviewing the applicable Cisco switch documentation, understanding supported RCF versions, and considering Smart Call Home configuration.
...
a|
4x100Gb mode for Intra-cluster, HA, and storage connections 
a|
Ethernet1/36
a|
