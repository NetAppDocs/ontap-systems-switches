...
[.lead]
You install the RCF on new Cisco Nexus 9808 switch(es) as part of a new AFX 2K system installation, replacing a FRU, or a switch reset to factory default settings.
