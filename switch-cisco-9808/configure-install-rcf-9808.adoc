...
summary: You install the RCF on new Cisco Nexus 9808 switch(es) as part of a new AFX 1K or AFX 2K system installation and setup, replacing a faulty switch, or resetting a switch to factory default settings.
---
...
[.lead]
You install the RCF on new Cisco Nexus 9808 switch(es) as part of a new AFX 1K or AFX 2K system installation, replacing a switch, or a switch reset to factory default settings.
