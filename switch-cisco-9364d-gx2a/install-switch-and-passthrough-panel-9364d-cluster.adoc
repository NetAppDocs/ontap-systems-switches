---
permalink: switch-cisco-9364d-gx2a/install-switch-and-passthrough-panel-9364d-cluster.html
sidebar: sidebar
keywords: install, cisco, nexus, switch, pass-through, panel, netapp, cabinet, bracket, switch, install a cisco nexus 9364d-gx2a switch and pass-through panel in a netapp cabinet - cisco nexus 9364d-gx2a
summary: You can install the Cisco Nexus9364d-gx2a switch and pass-through panel in a NetApp cabinet with the standard brackets that are included with the switch.
---
