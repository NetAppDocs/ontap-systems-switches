...
summary: You install the NX-OS on your Cisco Nexus 9364D-GX2A switch(es) as part of a new AFX 1K or AFX 2K system installation, a switch replacement, or a switch reset to factory default settings.
---
= Install the NX-OS - Cisco Nexus 9364D-GX2A
:icons: font
:imagesdir: ../media/

[.lead]
You install the NX-OS on your Cisco Nexus 9364D-GX2A switch(es) as part of a new AFX 1K or AFX 2K system installation, a switch replacement, or a switch reset to factory default settings.
