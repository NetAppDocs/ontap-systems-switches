...
+
For more information on Cisco commands, refer to the appropriate guide in the https://www.cisco.com/c/en/us/support/switches/nexus-9364c-fx2-switch/model.html#CommandReferences[Cisco Nexus 9000 Series NX-OS Command Reference^].
+
...
----
+
NOTE: For RCF 10.1 and later, the file name format is different: `RCF-v10.1-NX9364D-GX2A-CL1.txt`.
