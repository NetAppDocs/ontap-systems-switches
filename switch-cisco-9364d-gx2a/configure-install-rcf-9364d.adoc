...
+
You can link:configure-install-upgrade-rcf-overview-9364d.html#change-port-speed-configuration[change the port speed configuration] for RCF 10.1 as needed.
