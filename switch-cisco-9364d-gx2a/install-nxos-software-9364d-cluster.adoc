...
After you've installed or upgraded the NX-OS software, you can link:install-upgrade-rcf-overview-cluster-9364d.html[install or upgrade the Reference Configuration File (RCF)].
