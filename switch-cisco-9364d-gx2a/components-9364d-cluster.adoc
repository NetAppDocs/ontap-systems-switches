...
To activate more than 12 ports on your Cisco Nexus 9364D-GX2A cluster switch, you must purchase a Cisco Smart license. Cisco Smart licenses are managed through Cisco Smart accounts.
