...
| Switch port groups | Port speeds and usage
a|
Ethernet1/1/1-4 to Ethernet1/13/1-4
a|
...
After you've reviewed the install or upgrade RCF overview, you link:configure-install-rcf-9364d.html[install the RCF] or link:configure-upgrade-rcf-9364d.html[upgrade the RCF] as needed.
