...
[.lead]
You install the RCF after setting up the Nexus 9364D-GX2A switch for the first time. You upgrade your RCF version when you have an existing version of the RCF file installed on your switch. 
...
Refer to the link:https://hwu.netapp.com/SWITCH/INDEX[Hardware Universe^] to verify the correct cluster ports on your platforms.
...
After you've reviewed the install RCF or upgrade RCF procedure, you link:install-rcf-software-9364d-cluster.html[install the RCF] or link:upgrade-rcf-software-9364d-cluster.html[upgrade your RCF] as required.
