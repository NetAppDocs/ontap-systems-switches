...
summary: "Review the Cisco switch and NetApp systems documentation for Cisco Nexus 9364D-GX2A switch installation and maintenance in AFX 1K and AFX 2K systems."
---
= Review documentation requirements for the Cisco Nexus 9364D-GX2A switch
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the applicable Cisco switch documentation and NetApp systems documentation for Cisco Nexus 9364D-GX2A switch installation, configuration, and maintenance in AFX 1K and AFX 2K systems.

== Switch documentation
To set up the Cisco Nexus 9364D-GX2A switches, you need the following documentation from link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html[Cisco Nexus 9000 Series Switches Support^].
