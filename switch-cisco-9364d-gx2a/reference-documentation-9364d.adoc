...
---
= Reference documentation - Cisco Nexus 9364D-GX2A switches
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
For Cisco Nexus 9364D-GX2A switch installation, be sure to review specific switch and controller documentation to set up your Cisco 9364D-GX2A switches and ONTAP cluster.
