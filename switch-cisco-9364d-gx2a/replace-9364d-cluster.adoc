...
summary: Follow these steps to replace a defective Nexus 9364D-GX2A switch in a cluster network. This is a nondisruptive procedure (NDU).
---
= Replace a switch - Cisco Nexus 9364D-GX2A
:icons: font
:imagesdir: ../media/
