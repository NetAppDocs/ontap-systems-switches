...
summary: "Replace a defective Cisco Nexus 9364D-GX2A switch in an AFX system without disrupting operation. This is a nondisruptive procedure."
---
= Replace a Cisco Nexus 9364D-GX2A switch in an AFX system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a defective Cisco Nexus 9364D-GX2A switch in an AFX system without disrupting operation. This nondisruptive procedure (NDU) involves preparing a replacement switch and restoring the system configuration.
 ...
 ** Initial customization of the switch is complete, as detailed in link:configure-complete-initial-setup-9364d.html[Complete initial switch setup].
+
...
. Bring up all of the ports on the newcs2 switch.
+
.Show example 
[%collapsible]
====
...
// AFFFASDOC-476, 2026-MAR-30, typo fix, plus new step added