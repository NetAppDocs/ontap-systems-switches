...
=======
+
Installing the image file causes it to be loaded every time the switch reboots.
+
...
. Using the switch CLI, verify the new version of NX-OS after the switch reboots:
+
`show version`
+
