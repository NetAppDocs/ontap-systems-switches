...
summary: "Upgrade the NX-OS on Cisco Nexus 9364D-GX2A switches to support new hardware or a new ONTAP version on AFX 1K or AFX 2K systems."
---
= Upgrade NX-OS on the Cisco Nexus 9364D-GX2A switch
:icons: font
:imagesdir: ../media/

[.lead]
Upgrade the NX-OS on Cisco Nexus 9364D-GX2A switches to support new hardware or a new ONTAP version on AFX 1K or AFX 2K systems.
...
You install and verify the NX-OS and EPLD image on the first switch (cs1), verify the health of all ports on the cluster, and then repeat these steps on the second switch (cs2).

. Install the NX-OS and EPLD image. The steps can vary based on your current NX-OS version and the target NX-OS version. 
+
...
//These steps are reused from 9332 Upgrade NX-OS.
...
The example uses sftp and NX-OS version 10.6(4)M.

[subs=+quotes]

....
cs1# *copy sftp: bootflash: vrf management*
Enter source filename: */code/nxos64-cs.10.6.4.M.bin*
Enter hostname for the sftp server: *172.19.2.1*
Enter username: *user1*
...
sftp> *progress*
Progress meter enabled
sftp> *get /code/nxos64-cs.10.6.4.M.bin /bootflash/nxos64-cs.10.6.4.M.bin*
/code/nxos64-cs.10.6.4.M.bin  100% 1261MB   9.3MB/s   02:15
sftp> *exit*
Copy complete, now saving to disk (please wait)...
Copy complete.
....
...
Software
  BIOS: version 01.14
  NXOS: version 10.6.4.M [Feature Release]
  Host NXOS: version 10.6.4.M
  BIOS compile time:  11/25/2026
  NXOS image file is: bootflash:///nxos.10.6.4.M.bin
...
The example uses NX-OS version 10.6(4)M.

[subs=+quotes]

....
cs1# *install all nxos bootflash:/nxos64-cs.10.6.4.M.bin*

Installer will perform compatibility check first. Please wait.
Installer is forced disruptive

Verifying image bootflash:/nxos64-cs.10.6.4.M.bin for boot variable "nxos".
[####################] 100% -- SUCCESS

Verifying image type.
[####################] 100% -- SUCCESS

Preparing "nxos" version info using image bootflash:/nxos64-cs.10.6.4.M.bin.
[####################] 100% -- SUCCESS

Preparing "bios" version info using image bootflash:/nxos64-cs.10.6.4.M.bin.
[####################] 100% -- SUCCESS
...
Software
  ...
  NXOS image file is: bootflash:///nxos64-cs.10.6.4.M.bin
...
The example uses EPLD version 10.6(4)M.
...
EPLD Install Image: EPLD image file 10.6.4.M. built on Fri Apr 24 19:49:50 2026
...
EPLD Install Image: EPLD image file 10.6.4.M. built on Mon Mar 16 03:28:47 2026
...
EPLD Install Image: EPLD image file 10.6.4.M. built on Fri Dec 12 11:15:18 2026
...
EPLD Install Image: EPLD image file 10.6.4.M. built on Fri Dec 12 11:15:18 2025
...
node1-02/cdp
            ...
            e7b    cs2(FDO2846056X)         Ethernet1/16/2    N9K-C9364D-GX2A
...
After you've upgraded the NX-OS on your switches, you upgrade the RCF starting with the link:configure-install-upgrade-rcf-overview-9364d.html[Install or upgrade the RCF overview].
