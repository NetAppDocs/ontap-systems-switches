...
NOTE: NX-OS 10.4.2 is the only supported version for Cisco Nexus 9364D-GX2A switches in an ONTAP cluster, at this time.

IMPORTANT: Do not upgrade or downgrade your NX-OS version to an unsupported version; only 10.4.2 is currently supported.
