...
summary: Prepare to install NX-OS software and RCF.
---
...
After you've prepared to install the NX-OS software and RCF, you link:install-nxos-software-9364d-cluster.html[install or upgrade the NX-OS software].
