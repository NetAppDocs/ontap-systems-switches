...
summary: You upgrade the Reference Configuration File (RCF) version on your Cisco Nexus 9364D-GX2A switches to support new hardware, a new ONTAP version, or to align with a new NX-OS version in your AFX 1K or AFX 2K system configuration.
---
= Upgrade the RCF version - Cisco Nexus 9364D-GX2A
:icons: font
:imagesdir: ../media/

[.lead]
You upgrade the Reference Configuration File (RCF) version on your Cisco Nexus 9364D-GX2A switches to support new hardware, a new ONTAP version, or to align with a new NX-OS version in your AFX 1K or AFX 2K system configuration.
...
* To ensure non-disruptive cluster operations, this procedure has you migrate all of the cluster LIFs to the operational partner switch while performing the steps on the target switch.
...
+
If your switches are running RCF 10.1 or later, you can link:configure-install-upgrade-rcf-overview-9364d.html#change-port-speed-configuration[change the port speed configuration] if needed.
+
...
After you've upgraded the RCF on your switches, you link:configure-verify-ssh-9364d.html[verify SSH for log collection].
