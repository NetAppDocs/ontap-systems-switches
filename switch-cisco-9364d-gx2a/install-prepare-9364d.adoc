...
summary: "Prepare to install Cisco Nexus 9364D-GX2A switches as part of a new AFX 1K or AFX 2K system by reviewing switch documentation, supported RCF versions, and Smart Call Home requirements."
---
= Prepare to install Cisco Nexus 9364D-GX2A switches in an AFX system
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Prepare to install Cisco Nexus 9364D-GX2A switches as part of a new AFX 1K or AFX 2K system by reviewing the applicable Cisco switch documentation, understanding supported RCF versions, and considering Smart Call Home configuration.
...
include::../_include/understand-rcf-versions-9364d.adoc[]
