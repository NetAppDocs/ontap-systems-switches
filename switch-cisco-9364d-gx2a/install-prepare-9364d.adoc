...
* link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html[Cisco Nexus 9364D-GX2A NX-OS Mode Switch Hardware Installation Guide^]
...
+
For example, if you are using your switches as shared switches, you use RCF file `RCF-v10.1-NX9364D-GX2A-CL1-ST1-100GBR31-400G31.txt`. The following table shows the preset groups of the switch ports, their port speeds, and usage for this RCF file.
+
[options="header" cols="1,2"]
|===
| Switch port groups | Port speeds and usage
a|
Ethernet1/1/1-4 to Ethernet1/31/1-4
a|
...
More information about Smart Call Home can be found in the link:configure-smart-call-9364d.html[Configure Smart Call Home] documentation. 

.What's next?

After you've prepared to install your switches, you link:install-switches-9364d.html[install the switches].
