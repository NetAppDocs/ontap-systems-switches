...
summary: "Complete the initial setup of Cisco Nexus 9364D-GX2A switches using the configuration wizard for new AFX 1K or AFX 2K systems, switch replacements, or factory default resets."
---
= Complete the initial setup of the Cisco Nexus 9364D-GX2A switch
:icons: font
:imagesdir: ../media/

[.lead]
Complete the initial setup of Cisco Nexus 9364D-GX2A switches using the configuration wizard. This procedure applies to new AFX 1K or AFX 2K system installations, switch replacements, and switches reset to factory default settings.
