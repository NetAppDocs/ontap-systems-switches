...
After you've completed the initial switch setup, you link:configure-review-cabling-config-requirements-9364d.html[review the cabling and configuration requirements].
